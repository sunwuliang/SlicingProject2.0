...
/**
 * Need to import org.csu.slicing.coachbus project
 * @author sun
 *
 */
public class CoachBusInsHugeGenerator {
	...
	public static void main(String[] args) {
		...
		Set<EObject> objs = CoachBusInsHugeGenerator.generateInstance();
		EMFHelper.saveInstance(xmiFilePath, objs);
		
		// Test the generated instance file
		/*
		List<EObject> eObjs = EMFHelper.loadInstance(xmiFilePath);
