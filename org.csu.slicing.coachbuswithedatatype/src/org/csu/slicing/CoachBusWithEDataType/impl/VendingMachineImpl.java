 ...
 * <ul>
 *   <li>{@link org.csu.slicing.CoachBusWithEDataType.impl.VendingMachineImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBusWithEDataType.impl.VendingMachineImpl#getTickets <em>Tickets</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBusWithEDataType.impl.VendingMachineImpl#getOffice <em>Office</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VendingMachineImpl extends EObjectImpl implements VendingMachine {
	...
	protected EClass eStaticClass() {
		return CoachBusWithEDataTypePackage.Literals.VENDING_MACHINE;
	}
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.VENDING_MACHINE__NUMBER, oldNumber, number));
	}
	...
	public EList<Ticket> getTickets() {
		if (tickets == null) {
			tickets = new EObjectWithInverseResolvingEList<Ticket>(Ticket.class, this, CoachBusWithEDataTypePackage.VENDING_MACHINE__TICKETS, CoachBusWithEDataTypePackage.TICKET__VM);
		}
		return tickets;
	}
	...
	public BookingOffice getOffice() {
		if (office != null && office.eIsProxy()) {
			...
			if (office != oldOffice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CoachBusWithEDataTypePackage.VENDING_MACHINE__OFFICE, oldOffice, office));
			}
		}
		return office;
	}
	...
	public NotificationChain basicSetOffice(BookingOffice newOffice, NotificationChain msgs) {
		...
		office = newOffice;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.VENDING_MACHINE__OFFICE, oldOffice, newOffice);
	...
	public void setOffice(BookingOffice newOffice) {
		if (newOffice != office) {
			...
			if (office != null)
				msgs = ((InternalEObject)office).eInverseRemove(this, CoachBusWithEDataTypePackage.BOOKING_OFFICE__VMS, BookingOffice.class, msgs);
			if (newOffice != null)
				msgs = ((InternalEObject)newOffice).eInverseAdd(this, CoachBusWithEDataTypePackage.BOOKING_OFFICE__VMS, BookingOffice.class, msgs);
			msgs = basicSetOffice(newOffice, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.VENDING_MACHINE__OFFICE, newOffice, newOffice));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CoachBusWithEDataTypePackage.VENDING_MACHINE__TICKETS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTickets()).basicAdd(otherEnd, msgs);
			case CoachBusWithEDataTypePackage.VENDING_MACHINE__OFFICE:
				if (office != null)
					msgs = ((InternalEObject)office).eInverseRemove(this, CoachBusWithEDataTypePackage.BOOKING_OFFICE__VMS, BookingOffice.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoachBusWithEDataTypePackage.VENDING_MACHINE__NUMBER:
				return getNumber();
			case CoachBusWithEDataTypePackage.VENDING_MACHINE__TICKETS:
				return getTickets();
			case CoachBusWithEDataTypePackage.VENDING_MACHINE__OFFICE:
