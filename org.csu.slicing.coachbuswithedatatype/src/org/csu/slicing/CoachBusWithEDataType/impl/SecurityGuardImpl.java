 ...
 * <ul>
 *   <li>{@link org.csu.slicing.CoachBusWithEDataType.impl.SecurityGuardImpl#getShift <em>Shift</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBusWithEDataType.impl.SecurityGuardImpl#getCoach <em>Coach</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SecurityGuardImpl extends EmployeeImpl implements SecurityGuard {
	...
	protected EClass eStaticClass() {
		return CoachBusWithEDataTypePackage.Literals.SECURITY_GUARD;
	}
	...
	public void setShift(String newShift) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.SECURITY_GUARD__SHIFT, oldShift, shift));
	}
	...
	public Coach getCoach() {
		if (coach != null && coach.eIsProxy()) {
			...
			if (coach != oldCoach) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CoachBusWithEDataTypePackage.SECURITY_GUARD__COACH, oldCoach, coach));
			}
		}
		return coach;
	}
	...
	public NotificationChain basicSetCoach(Coach newCoach, NotificationChain msgs) {
		...
		coach = newCoach;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.SECURITY_GUARD__COACH, oldCoach, newCoach);
	...
	public void setCoach(Coach newCoach) {
		if (newCoach != coach) {
			...
			if (coach != null)
				msgs = ((InternalEObject)coach).eInverseRemove(this, CoachBusWithEDataTypePackage.COACH__GUARDS, Coach.class, msgs);
			if (newCoach != null)
				msgs = ((InternalEObject)newCoach).eInverseAdd(this, CoachBusWithEDataTypePackage.COACH__GUARDS, Coach.class, msgs);
			msgs = basicSetCoach(newCoach, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.SECURITY_GUARD__COACH, newCoach, newCoach));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CoachBusWithEDataTypePackage.SECURITY_GUARD__COACH:
				if (coach != null)
					msgs = ((InternalEObject)coach).eInverseRemove(this, CoachBusWithEDataTypePackage.COACH__GUARDS, Coach.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoachBusWithEDataTypePackage.SECURITY_GUARD__SHIFT:
				return getShift();
			case CoachBusWithEDataTypePackage.SECURITY_GUARD__COACH:
