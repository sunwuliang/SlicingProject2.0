 ...
 * <ul>
 *   <li>{@link org.csu.slicing.CoachBusWithEDataType.impl.AdultTicketImpl#isIsElderlyDiscount <em>Is Elderly Discount</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdultTicketImpl extends TicketImpl implements AdultTicket {
	...
	protected EClass eStaticClass() {
		return CoachBusWithEDataTypePackage.Literals.ADULT_TICKET;
	}
	...
	public void setIsElderlyDiscount(boolean newIsElderlyDiscount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusWithEDataTypePackage.ADULT_TICKET__IS_ELDERLY_DISCOUNT, oldIsElderlyDiscount, isElderlyDiscount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoachBusWithEDataTypePackage.ADULT_TICKET__IS_ELDERLY_DISCOUNT:
