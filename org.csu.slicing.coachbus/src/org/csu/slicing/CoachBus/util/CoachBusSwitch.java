 ...
 * @generated
 */
public class CoachBusSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoachBusPackage.TRIP: {
				Trip trip = (Trip)theEObject;
				T result = caseTrip(trip);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoachBusPackage.REGULAR_TRIP: {
			...
			case CoachBusPackage.PRIVATE_TRIP: {
			...
			case CoachBusPackage.CHILD_TICKET: {
