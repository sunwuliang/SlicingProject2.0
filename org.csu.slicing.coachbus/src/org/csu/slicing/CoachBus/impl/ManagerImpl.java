 ...
 * <ul>
 *   <li>{@link org.csu.slicing.CoachBus.impl.ManagerImpl#isHasMBA <em>Has MBA</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBus.impl.ManagerImpl#getOffice <em>Office</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ManagerImpl extends EmployeeImpl implements Manager {
	...
	protected EClass eStaticClass() {
		return CoachBusPackage.Literals.MANAGER;
	}
	...
	public void setHasMBA(boolean newHasMBA) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.MANAGER__HAS_MBA, oldHasMBA, hasMBA));
	}
	...
	public BookingOffice getOffice() {
		if (office != null && office.eIsProxy()) {
			...
			if (office != oldOffice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CoachBusPackage.MANAGER__OFFICE, oldOffice, office));
			}
		}
		return office;
	}
	...
	public NotificationChain basicSetOffice(BookingOffice newOffice, NotificationChain msgs) {
		...
		office = newOffice;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CoachBusPackage.MANAGER__OFFICE, oldOffice, newOffice);
	...
	public void setOffice(BookingOffice newOffice) {
		if (newOffice != office) {
			...
			if (office != null)
				msgs = ((InternalEObject)office).eInverseRemove(this, CoachBusPackage.BOOKING_OFFICE__MANAGER, BookingOffice.class, msgs);
			if (newOffice != null)
				msgs = ((InternalEObject)newOffice).eInverseAdd(this, CoachBusPackage.BOOKING_OFFICE__MANAGER, BookingOffice.class, msgs);
			msgs = basicSetOffice(newOffice, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.MANAGER__OFFICE, newOffice, newOffice));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CoachBusPackage.MANAGER__OFFICE:
				if (office != null)
					msgs = ((InternalEObject)office).eInverseRemove(this, CoachBusPackage.BOOKING_OFFICE__MANAGER, BookingOffice.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoachBusPackage.MANAGER__HAS_MBA:
				return isHasMBA();
			case CoachBusPackage.MANAGER__OFFICE:
