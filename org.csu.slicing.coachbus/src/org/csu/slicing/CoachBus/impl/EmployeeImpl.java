 ...
 * <ul>
 *   <li>{@link org.csu.slicing.CoachBus.impl.EmployeeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBus.impl.EmployeeImpl#getBaseSalary <em>Base Salary</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EmployeeImpl extends EObjectImpl implements Employee {
	...
	protected EClass eStaticClass() {
		return CoachBusPackage.Literals.EMPLOYEE;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.EMPLOYEE__ID, oldId, id));
	}
	...
	public void setBaseSalary(double newBaseSalary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.EMPLOYEE__BASE_SALARY, oldBaseSalary, baseSalary));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoachBusPackage.EMPLOYEE__ID:
				return getId();
			case CoachBusPackage.EMPLOYEE__BASE_SALARY:
