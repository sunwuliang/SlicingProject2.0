 ...
 * <ul>
 *   <li>{@link org.csu.slicing.CoachBus.impl.TicketImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBus.impl.TicketImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBus.impl.TicketImpl#isIsRoundTrip <em>Is Round Trip</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBus.impl.TicketImpl#getPsg <em>Psg</em>}</li>
 *   <li>{@link org.csu.slicing.CoachBus.impl.TicketImpl#getVm <em>Vm</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TicketImpl extends EObjectImpl implements Ticket {
	...
	protected EClass eStaticClass() {
		return CoachBusPackage.Literals.TICKET;
	}
	...
	public void setNumber(int newNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__NUMBER, oldNumber, number));
	}
	...
	public void setPrice(double newPrice) {
		...
		price = newPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__PRICE, oldPrice, price));
	}
	...
	public void setIsRoundTrip(boolean newIsRoundTrip) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__IS_ROUND_TRIP, oldIsRoundTrip, isRoundTrip));
	}
	...
	public Passenger getPsg() {
		if (psg != null && psg.eIsProxy()) {
			...
			if (psg != oldPsg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CoachBusPackage.TICKET__PSG, oldPsg, psg));
			}
		}
		return psg;
	}
	...
	public NotificationChain basicSetPsg(Passenger newPsg, NotificationChain msgs) {
		...
		psg = newPsg;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__PSG, oldPsg, newPsg);
	...
	public void setPsg(Passenger newPsg) {
		if (newPsg != psg) {
			...
			if (psg != null)
				msgs = ((InternalEObject)psg).eInverseRemove(this, CoachBusPackage.PASSENGER__TICKETS, Passenger.class, msgs);
			if (newPsg != null)
				msgs = ((InternalEObject)newPsg).eInverseAdd(this, CoachBusPackage.PASSENGER__TICKETS, Passenger.class, msgs);
			msgs = basicSetPsg(newPsg, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__PSG, newPsg, newPsg));
	}
	...
	public VendingMachine getVm() {
		if (vm != null && vm.eIsProxy()) {
			...
			if (vm != oldVm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CoachBusPackage.TICKET__VM, oldVm, vm));
			}
		}
		return vm;
	}
	...
	public NotificationChain basicSetVm(VendingMachine newVm, NotificationChain msgs) {
		...
		vm = newVm;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__VM, oldVm, newVm);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVm(VendingMachine newVm) {
		if (newVm != vm) {
			NotificationChain msgs = null;
			if (vm != null)
				msgs = ((InternalEObject)vm).eInverseRemove(this, CoachBusPackage.VENDING_MACHINE__TICKETS, VendingMachine.class, msgs);
			if (newVm != null)
				msgs = ((InternalEObject)newVm).eInverseAdd(this, CoachBusPackage.VENDING_MACHINE__TICKETS, VendingMachine.class, msgs);
			msgs = basicSetVm(newVm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoachBusPackage.TICKET__VM, newVm, newVm));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CoachBusPackage.TICKET__PSG:
				if (psg != null)
					msgs = ((InternalEObject)psg).eInverseRemove(this, CoachBusPackage.PASSENGER__TICKETS, Passenger.class, msgs);
				return basicSetPsg((Passenger)otherEnd, msgs);
			case CoachBusPackage.TICKET__VM:
				if (vm != null)
					msgs = ((InternalEObject)vm).eInverseRemove(this, CoachBusPackage.VENDING_MACHINE__TICKETS, VendingMachine.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoachBusPackage.TICKET__NUMBER:
				return getNumber();
			case CoachBusPackage.TICKET__PRICE:
				return getPrice();
			case CoachBusPackage.TICKET__IS_ROUND_TRIP:
