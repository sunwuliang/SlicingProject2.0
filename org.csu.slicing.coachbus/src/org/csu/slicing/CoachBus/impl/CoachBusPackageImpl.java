...
import org.csu.slicing.CoachBus.CoachBusWithEDataTypeFactory;
import org.csu.slicing.CoachBus.CoachBusPackage;
import org.csu.slicing.CoachBus.Employee;
...
import org.csu.slicing.CoachBus.RegularTrip;
 ...
 * @generated
 */
public class CoachBusPackageImpl extends EPackageImpl implements CoachBusPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.csu.slicing.CoachBus.CoachBusPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CoachBusPackageImpl() {
	 ...
	 * 
	 * <p>This method is used to initialize {@link CoachBusPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CoachBusPackage init() {
		if (isInited) return (CoachBusPackage)EPackage.Registry.INSTANCE.getEPackage(CoachBusPackage.eNS_URI);

		// Obtain or create and register package
		CoachBusPackageImpl theCoachBusPackage = (CoachBusPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CoachBusPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CoachBusPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theCoachBusPackage.createPackageContents();

		// Initialize created meta-data
		theCoachBusPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCoachBusPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CoachBusPackage.eNS_URI, theCoachBusPackage);
		return theCoachBusPackage;
	}
	 ...
	 * @generated
	 */
	public CoachBusWithEDataTypeFactory getCoachBusFactory() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTrip_Type(), ecorePackage.getEString(), "type", null, 0, 1, Trip.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
