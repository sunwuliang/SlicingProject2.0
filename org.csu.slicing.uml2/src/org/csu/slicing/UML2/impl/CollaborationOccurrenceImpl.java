 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.CollaborationOccurrenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.CollaborationOccurrenceImpl#getRoleBinding <em>Role Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollaborationOccurrenceImpl extends NamedElementImpl implements CollaborationOccurrence {
	...
	public EList<Dependency> getRoleBinding() {
		if (roleBinding == null) {
			roleBinding = new EObjectContainmentEList<Dependency>(Dependency.class, this, UML2Package.COLLABORATION_OCCURRENCE__ROLE_BINDING);
		}
		return roleBinding;
	}
