 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.PinImpl#isIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PinImpl#isIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PinImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PinImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PinImpl#getUpperValue <em>Upper Value</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PinImpl#getLowerValue <em>Lower Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PinImpl extends ObjectNodeImpl implements Pin {
	...
	public void setLower(int newLower) {
		...
		lower = newLower;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.PIN__LOWER, oldLower, lower));
	}
	...
	public void setUpper(String newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.PIN__UPPER, oldUpper, upper));
	}
