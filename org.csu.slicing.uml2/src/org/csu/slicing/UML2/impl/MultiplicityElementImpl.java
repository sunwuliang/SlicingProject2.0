 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.MultiplicityElementImpl#isIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MultiplicityElementImpl#isIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MultiplicityElementImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MultiplicityElementImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MultiplicityElementImpl#getUpperValue <em>Upper Value</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MultiplicityElementImpl#getLowerValue <em>Lower Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MultiplicityElementImpl extends ElementImpl implements MultiplicityElement {
	...
	public void setLower(int newLower) {
		...
		lower = newLower;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.MULTIPLICITY_ELEMENT__LOWER, oldLower, lower));
	}
	...
	public void setUpper(String newUpper) {
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.MULTIPLICITY_ELEMENT__UPPER, oldUpper, upper));
	}
