 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getMessageKind <em>Message Kind</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getMessageSort <em>Message Sort</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getReceiveEvent <em>Receive Event</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getSendEvent <em>Send Event</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getSignature <em>Signature</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.MessageImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends NamedElementImpl implements Message {
	...
	public void setMessageKind(MessageKind newMessageKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.MESSAGE__MESSAGE_KIND, oldMessageKind, messageKind));
	}
