 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getTemplateParameter <em>Template Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getOwningParameter <em>Owning Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getPackageableElement_visibility <em>Packageable Element visibility</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getNestedPackage <em>Nested Package</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getNestingPackage <em>Nesting Package</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getOwnedType <em>Owned Type</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getOwnedMember <em>Owned Member</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getPackageMerge <em>Package Merge</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getAppliedProfile <em>Applied Profile</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.PackageImpl#getPackageExtension <em>Package Extension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PackageImpl extends NamespaceImpl implements org.csu.slicing.UML2.Package {
	/**
	 ...
	 * @ordered
	 */
	protected EList<org.csu.slicing.UML2.Package> nestedPackage;
	 ...
	 * @ordered
	 */
	protected org.csu.slicing.UML2.Package nestingPackage;
	 ...
	 * @generated
	 */
	public EList<org.csu.slicing.UML2.Package> getNestedPackage() {
		if (nestedPackage == null) {
			nestedPackage = new EObjectWithInverseResolvingEList<org.csu.slicing.UML2.Package>(org.csu.slicing.UML2.Package.class, this, UML2Package.PACKAGE__NESTED_PACKAGE, UML2Package.PACKAGE__NESTING_PACKAGE);
		}
	 ...
	 * @generated
	 */
	public org.csu.slicing.UML2.Package getNestingPackage() {
		if (nestingPackage != null && nestingPackage.eIsProxy()) {
			InternalEObject oldNestingPackage = (InternalEObject)nestingPackage;
			nestingPackage = (org.csu.slicing.UML2.Package)eResolveProxy(oldNestingPackage);
			if (nestingPackage != oldNestingPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2Package.PACKAGE__NESTING_PACKAGE, oldNestingPackage, nestingPackage));
			}
		}
	 ...
	 * @generated
	 */
	public org.csu.slicing.UML2.Package basicGetNestingPackage() {
		return nestingPackage;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetNestingPackage(org.csu.slicing.UML2.Package newNestingPackage, NotificationChain msgs) {
		org.csu.slicing.UML2.Package oldNestingPackage = nestingPackage;
		nestingPackage = newNestingPackage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2Package.PACKAGE__NESTING_PACKAGE, oldNestingPackage, newNestingPackage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setNestingPackage(org.csu.slicing.UML2.Package newNestingPackage) {
		if (newNestingPackage != nestingPackage) {
			NotificationChain msgs = null;
			if (nestingPackage != null)
				msgs = ((InternalEObject)nestingPackage).eInverseRemove(this, UML2Package.PACKAGE__NESTED_PACKAGE, org.csu.slicing.UML2.Package.class, msgs);
			if (newNestingPackage != null)
				msgs = ((InternalEObject)newNestingPackage).eInverseAdd(this, UML2Package.PACKAGE__NESTED_PACKAGE, org.csu.slicing.UML2.Package.class, msgs);
			msgs = basicSetNestingPackage(newNestingPackage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.PACKAGE__NESTING_PACKAGE, newNestingPackage, newNestingPackage));
	}
	...
	public EList<Type> getOwnedType() {
		if (ownedType == null) {
			ownedType = new EObjectWithInverseResolvingEList<Type>(Type.class, this, UML2Package.PACKAGE__OWNED_TYPE, UML2Package.TYPE__PACKAGE);
		}
		return ownedType;
	}
	...
	public EList<PackageableElement> getOwnedMember() {
		if (ownedMember == null) {
			ownedMember = new EObjectContainmentEList<PackageableElement>(PackageableElement.class, this, UML2Package.PACKAGE__OWNED_MEMBER);
		}
		return ownedMember;
	}
	...
	public EList<PackageMerge> getPackageMerge() {
		if (packageMerge == null) {
			packageMerge = new EObjectWithInverseResolvingEList<PackageMerge>(PackageMerge.class, this, UML2Package.PACKAGE__PACKAGE_MERGE, UML2Package.PACKAGE_MERGE__MERGING_PACKAGE);
		}
		return packageMerge;
	}
	...
	public EList<ProfileApplication> getAppliedProfile() {
		if (appliedProfile == null) {
			appliedProfile = new EObjectResolvingEList<ProfileApplication>(ProfileApplication.class, this, UML2Package.PACKAGE__APPLIED_PROFILE);
		}
	...
	public EList<PackageMerge> getPackageExtension() {
		if (packageExtension == null) {
			packageExtension = new EObjectContainmentEList<PackageMerge>(PackageMerge.class, this, UML2Package.PACKAGE__PACKAGE_EXTENSION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2Package.PACKAGE__NESTING_PACKAGE:
				if (nestingPackage != null)
					msgs = ((InternalEObject)nestingPackage).eInverseRemove(this, UML2Package.PACKAGE__NESTED_PACKAGE, org.csu.slicing.UML2.Package.class, msgs);
				return basicSetNestingPackage((org.csu.slicing.UML2.Package)otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UML2Package.PACKAGE__NESTED_PACKAGE:
				...
				getNestedPackage().addAll((Collection<? extends org.csu.slicing.UML2.Package>)newValue);
				return;
			case UML2Package.PACKAGE__NESTING_PACKAGE:
				setNestingPackage((org.csu.slicing.UML2.Package)newValue);
				return;
			case UML2Package.PACKAGE__OWNED_TYPE:
				getOwnedType().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case UML2Package.PACKAGE__NESTED_PACKAGE:
				...
				return;
			case UML2Package.PACKAGE__NESTING_PACKAGE:
				setNestingPackage((org.csu.slicing.UML2.Package)null);
				return;
			case UML2Package.PACKAGE__OWNED_TYPE:
				getOwnedType().clear();
				return;
