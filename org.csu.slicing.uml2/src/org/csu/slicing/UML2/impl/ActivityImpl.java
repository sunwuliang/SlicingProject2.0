 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getNode <em>Node</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getAction <em>Action</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#getStructuredNode <em>Structured Node</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#isIsSingleExecution <em>Is Single Execution</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityImpl#isIsReadOnly <em>Is Read Only</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityImpl extends BehaviorImpl implements Activity {
	...
	public EList<ActivityGroup> getGroup() {
		if (group == null) {
			group = new EObjectContainmentWithInverseEList<ActivityGroup>(ActivityGroup.class, this, UML2Package.ACTIVITY__GROUP, UML2Package.ACTIVITY_GROUP__ACTIVITY_GROUP_ACTIVITY);
		}
		return group;
	}
	...
	public EList<Action> getAction() {
		if (action == null) {
			action = new EObjectResolvingEList<Action>(Action.class, this, UML2Package.ACTIVITY__ACTION);
		}
		return action;
	}
	...
	public EList<StructuredActivityNode> getStructuredNode() {
		if (structuredNode == null) {
			structuredNode = new EObjectResolvingEList<StructuredActivityNode>(StructuredActivityNode.class, this, UML2Package.ACTIVITY__STRUCTURED_NODE);
		}
