 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.RedefinableElementImpl#getRedefinitionContext <em>Redefinition Context</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.RedefinableElementImpl#isIsLeaf <em>Is Leaf</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RedefinableElementImpl extends NamedElementImpl implements RedefinableElement {
	...
	public EList<Classifier> getRedefinitionContext() {
		if (redefinitionContext == null) {
			redefinitionContext = new EObjectResolvingEList<Classifier>(Classifier.class, this, UML2Package.REDEFINABLE_ELEMENT__REDEFINITION_CONTEXT);
		}
