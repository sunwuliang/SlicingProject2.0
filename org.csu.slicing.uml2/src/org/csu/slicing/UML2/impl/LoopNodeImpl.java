 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#isIsTestedFirst <em>Is Tested First</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getBodyPart <em>Body Part</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getSetupPart <em>Setup Part</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getDecider <em>Decider</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getTest <em>Test</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getResult <em>Result</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getLoopVariable <em>Loop Variable</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getBodyOutput <em>Body Output</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.LoopNodeImpl#getLoopVariableInput <em>Loop Variable Input</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoopNodeImpl extends StructuredActivityNodeImpl implements LoopNode {
	...
	public EList<ActivityNode> getBodyPart() {
		if (bodyPart == null) {
			bodyPart = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UML2Package.LOOP_NODE__BODY_PART);
		}
		return bodyPart;
	}
	...
	public EList<ActivityNode> getSetupPart() {
		if (setupPart == null) {
			setupPart = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UML2Package.LOOP_NODE__SETUP_PART);
		}
		return setupPart;
	}
	...
	public EList<ActivityNode> getTest() {
		if (test == null) {
			test = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UML2Package.LOOP_NODE__TEST);
		}
		return test;
	}
	...
	public EList<OutputPin> getLoopVariable() {
		if (loopVariable == null) {
			loopVariable = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, UML2Package.LOOP_NODE__LOOP_VARIABLE);
		}
		return loopVariable;
	}
