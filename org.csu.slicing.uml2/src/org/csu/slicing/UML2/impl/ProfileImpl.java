 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ProfileImpl#getOwnedStereotype <em>Owned Stereotype</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ProfileImpl#getMetaclassReference <em>Metaclass Reference</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ProfileImpl#getMetamodelReference <em>Metamodel Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProfileImpl extends PackageImpl implements Profile {
	...
	public EList<Stereotype> getOwnedStereotype() {
		if (ownedStereotype == null) {
			ownedStereotype = new EObjectResolvingEList<Stereotype>(Stereotype.class, this, UML2Package.PROFILE__OWNED_STEREOTYPE);
		}
