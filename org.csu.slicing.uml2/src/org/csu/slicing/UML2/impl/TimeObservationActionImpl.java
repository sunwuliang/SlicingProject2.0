 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.TimeObservationActionImpl#getNow <em>Now</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeObservationActionImpl extends WriteStructuralFeatureActionImpl implements TimeObservationAction {
	...
	public EList<TimeExpression> getNow() {
		if (now == null) {
			now = new EObjectContainmentEList<TimeExpression>(TimeExpression.class, this, UML2Package.TIME_OBSERVATION_ACTION__NOW);
		}
		return now;
	}
