 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ActionImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActionImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActionImpl#getInput <em>Input</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActionImpl#getContext_ <em>Context </em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActionImpl#getLocalPrecondition <em>Local Precondition</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActionImpl#getLocalPostcondition <em>Local Postcondition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionImpl extends ExecutableNodeImpl implements Action {
	...
	public EList<OutputPin> getOutput() {
		if (output == null) {
			output = new EObjectResolvingEList<OutputPin>(OutputPin.class, this, UML2Package.ACTION__OUTPUT);
		}
		return output;
	}
	...
	public EList<InputPin> getInput() {
		if (input == null) {
			input = new EObjectResolvingEList<InputPin>(InputPin.class, this, UML2Package.ACTION__INPUT);
		}
		return input;
	}
	...
	public Classifier getContext_() {
		if (context_ != null && context_.eIsProxy()) {
			...
			if (context_ != oldContext_) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2Package.ACTION__CONTEXT_, oldContext_, context_));
			}
		}
		return context_;
	}
	...
	public void setContext_(Classifier newContext_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.ACTION__CONTEXT_, oldContext_, context_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2Package.ACTION__INPUT:
				return getInput();
			case UML2Package.ACTION__CONTEXT_:
