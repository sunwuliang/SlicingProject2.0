 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ElementImpl#getOwnedElement <em>Owned Element</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ElementImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ElementImpl#getOwnedComment <em>Owned Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ElementImpl extends EObjectImpl implements Element {
	...
	public EList<Element> getOwnedElement() {
		if (ownedElement == null) {
			ownedElement = new EObjectWithInverseResolvingEList<Element>(Element.class, this, UML2Package.ELEMENT__OWNED_ELEMENT, UML2Package.ELEMENT__OWNER);
		}
		return ownedElement;
	}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2Package.ELEMENT__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public NotificationChain basicSetOwner(Element newOwner, NotificationChain msgs) {
		...
		owner = newOwner;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2Package.ELEMENT__OWNER, oldOwner, newOwner);
	...
	public void setOwner(Element newOwner) {
		if (newOwner != owner) {
			...
			if (owner != null)
				msgs = ((InternalEObject)owner).eInverseRemove(this, UML2Package.ELEMENT__OWNED_ELEMENT, Element.class, msgs);
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, UML2Package.ELEMENT__OWNED_ELEMENT, Element.class, msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.ELEMENT__OWNER, newOwner, newOwner));
	}
