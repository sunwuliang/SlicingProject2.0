 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ClauseImpl#getTest <em>Test</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ClauseImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ClauseImpl#getPredecessorClause <em>Predecessor Clause</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ClauseImpl#getSuccessorClause <em>Successor Clause</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ClauseImpl#getDecider <em>Decider</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ClauseImpl#getBodyOutput <em>Body Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClauseImpl extends ElementImpl implements Clause {
	...
	public EList<ActivityNode> getTest() {
		if (test == null) {
			test = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UML2Package.CLAUSE__TEST);
		}
		return test;
	}
	...
	public EList<ActivityNode> getBody() {
		if (body == null) {
			body = new EObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UML2Package.CLAUSE__BODY);
		}
		return body;
	}
