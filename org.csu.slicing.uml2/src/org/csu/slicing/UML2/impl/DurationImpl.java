 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.DurationImpl#isFirstTime <em>First Time</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.DurationImpl#getEvent <em>Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationImpl extends ValueSpecificationImpl implements Duration {
	...
	public EList<NamedElement> getEvent() {
		if (event == null) {
			event = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, UML2Package.DURATION__EVENT);
		}
		return event;
	}
