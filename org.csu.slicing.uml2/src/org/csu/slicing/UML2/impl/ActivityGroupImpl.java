 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityGroupImpl#getSuperGroup <em>Super Group</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityGroupImpl#getActivityGroup_activity <em>Activity Group activity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ActivityGroupImpl extends ElementImpl implements ActivityGroup {
		...
		if (superGroup != null && superGroup.eIsProxy()) {
			...
			if (superGroup != oldSuperGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2Package.ACTIVITY_GROUP__SUPER_GROUP, oldSuperGroup, superGroup));
			}
		}
		return superGroup;
	}
	...
	public void setSuperGroup(ActivityGroup newSuperGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2Package.ACTIVITY_GROUP__SUPER_GROUP, oldSuperGroup, superGroup));
	}
