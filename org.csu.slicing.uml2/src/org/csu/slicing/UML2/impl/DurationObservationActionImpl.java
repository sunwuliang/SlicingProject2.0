 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.DurationObservationActionImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationObservationActionImpl extends WriteStructuralFeatureActionImpl implements DurationObservationAction {
	...
	public EList<Duration> getDuration() {
		if (duration == null) {
			duration = new EObjectContainmentEList<Duration>(Duration.class, this, UML2Package.DURATION_OBSERVATION_ACTION__DURATION);
		}
		return duration;
	}
