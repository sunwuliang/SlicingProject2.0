 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ReplyActionImpl#getReplyToCall <em>Reply To Call</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ReplyActionImpl#getReplyValue <em>Reply Value</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ReplyActionImpl#getReturnInformation <em>Return Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReplyActionImpl extends ActionImpl implements ReplyAction {
	...
	public EList<InputPin> getReplyValue() {
		if (replyValue == null) {
			replyValue = new EObjectResolvingEList<InputPin>(InputPin.class, this, UML2Package.REPLY_ACTION__REPLY_VALUE);
		}
		return replyValue;
	}
