 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.AcceptEventActionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.AcceptEventActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcceptEventActionImpl extends ActionImpl implements AcceptEventAction {
	...
	public EList<Trigger> getTrigger() {
		if (trigger == null) {
			trigger = new EObjectResolvingEList<Trigger>(Trigger.class, this, UML2Package.ACCEPT_EVENT_ACTION__TRIGGER);
		}
		return trigger;
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectResolvingEList<OutputPin>(OutputPin.class, this, UML2Package.ACCEPT_EVENT_ACTION__RESULT);
		}
		return result;
	}
