 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getInGroup <em>In Group</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getRedefinedElement <em>Redefined Element</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getInStructuredNode <em>In Structured Node</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getInPartition <em>In Partition</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.ActivityEdgeImpl#getInterrupts <em>Interrupts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ActivityEdgeImpl extends RedefinableElementImpl implements ActivityEdge {
	...
	public EList<ActivityGroup> getInGroup() {
		if (inGroup == null) {
			inGroup = new EObjectResolvingEList<ActivityGroup>(ActivityGroup.class, this, UML2Package.ACTIVITY_EDGE__IN_GROUP);
		}
		return inGroup;
	}
	...
	public EList<ActivityEdge> getRedefinedElement() {
		if (redefinedElement == null) {
			redefinedElement = new EObjectResolvingEList<ActivityEdge>(ActivityEdge.class, this, UML2Package.ACTIVITY_EDGE__REDEFINED_ELEMENT);
		}
	...
	public EList<ActivityPartition> getInPartition() {
		if (inPartition == null) {
			inPartition = new EObjectWithInverseResolvingEList.ManyInverse<ActivityPartition>(ActivityPartition.class, this, UML2Package.ACTIVITY_EDGE__IN_PARTITION, UML2Package.ACTIVITY_PARTITION__CONTAINED_EDGE);
		}
		return inPartition;
	}
