 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.FeatureImpl#getFeaturingClassifier <em>Featuring Classifier</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.FeatureImpl#isIsStatic <em>Is Static</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FeatureImpl extends RedefinableElementImpl implements Feature {
	...
	public EList<Classifier> getFeaturingClassifier() {
		if (featuringClassifier == null) {
			featuringClassifier = new EObjectWithInverseResolvingEList.ManyInverse<Classifier>(Classifier.class, this, UML2Package.FEATURE__FEATURING_CLASSIFIER, UML2Package.CLASSIFIER__FEATURE);
		}
