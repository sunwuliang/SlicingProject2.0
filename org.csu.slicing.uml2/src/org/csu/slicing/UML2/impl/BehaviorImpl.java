 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#isIsReentrant <em>Is Reentrant</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getContext <em>Context</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getRedefinedBehavior <em>Redefined Behavior</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getFormalParameter <em>Formal Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getReturnResult <em>Return Result</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getPostcondition <em>Postcondition</em>}</li>
 *   <li>{@link org.csu.slicing.UML2.impl.BehaviorImpl#getOwnedParameterSet <em>Owned Parameter Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BehaviorImpl extends ClassImpl implements Behavior {
	...
	public EList<Parameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, UML2Package.BEHAVIOR__PARAMETER);
		}
		return parameter;
	}
	...
	public EList<Parameter> getFormalParameter() {
		if (formalParameter == null) {
			formalParameter = new EObjectResolvingEList<Parameter>(Parameter.class, this, UML2Package.BEHAVIOR__FORMAL_PARAMETER);
		}
	...
	public EList<Parameter> getReturnResult() {
		if (returnResult == null) {
			returnResult = new EObjectResolvingEList<Parameter>(Parameter.class, this, UML2Package.BEHAVIOR__RETURN_RESULT);
		}
		return returnResult;
	}
