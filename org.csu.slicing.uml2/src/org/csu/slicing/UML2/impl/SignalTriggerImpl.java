 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2.impl.SignalTriggerImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignalTriggerImpl extends MessageTriggerImpl implements SignalTrigger {
	...
	public EList<Signal> getSignal() {
		if (signal == null) {
			signal = new EObjectResolvingEList<Signal>(Signal.class, this, UML2Package.SIGNAL_TRIGGER__SIGNAL);
		}
		return signal;
	}
