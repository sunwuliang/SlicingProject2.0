 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LiteralBooleanImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralBooleanImpl extends LiteralSpecificationImpl implements LiteralBoolean {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getLiteralBoolean();
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LITERAL_BOOLEAN__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.LITERAL_BOOLEAN__VALUE:
				return isValue();
		}
