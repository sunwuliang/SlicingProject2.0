 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PortImpl#isIsBehavior <em>Is Behavior</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PortImpl#isIsService <em>Is Service</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PortImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PortImpl#getRedefinedPort <em>Redefined Port</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PortImpl#getProvided <em>Provided</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PortImpl#getProtocol <em>Protocol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortImpl extends PropertyImpl implements Port {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getPort();
	}
	...
	public void setIsBehavior(boolean newIsBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PORT__IS_BEHAVIOR, oldIsBehavior, isBehavior));
	}
	...
	public void setIsService(boolean newIsService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PORT__IS_SERVICE, oldIsService, isService));
	}
	...
	public EList<Interface> getRequired() {
		if (required == null) {
			required = new EObjectResolvingEList<Interface>(Interface.class, this, UML2WithIDPackage.PORT__REQUIRED);
		}
		return required;
	}
	...
	public EList<Port> getRedefinedPort() {
		if (redefinedPort == null) {
			redefinedPort = new EObjectResolvingEList<Port>(Port.class, this, UML2WithIDPackage.PORT__REDEFINED_PORT);
		}
	...
	public EList<Interface> getProvided() {
		if (provided == null) {
			provided = new EObjectResolvingEList<Interface>(Interface.class, this, UML2WithIDPackage.PORT__PROVIDED);
		}
		return provided;
	}
	...
	public ProtocolStateMachine getProtocol() {
		if (protocol != null && protocol.eIsProxy()) {
			...
			if (protocol != oldProtocol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.PORT__PROTOCOL, oldProtocol, protocol));
			}
		}
		return protocol;
	}
	...
	public void setProtocol(ProtocolStateMachine newProtocol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PORT__PROTOCOL, oldProtocol, protocol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.PORT__IS_BEHAVIOR:
				return isIsBehavior();
			case UML2WithIDPackage.PORT__IS_SERVICE:
				return isIsService();
			case UML2WithIDPackage.PORT__REQUIRED:
				return getRequired();
			case UML2WithIDPackage.PORT__REDEFINED_PORT:
				return getRedefinedPort();
			case UML2WithIDPackage.PORT__PROVIDED:
				return getProvided();
			case UML2WithIDPackage.PORT__PROTOCOL:
