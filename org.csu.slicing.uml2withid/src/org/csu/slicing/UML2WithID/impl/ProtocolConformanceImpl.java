 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProtocolConformanceImpl#getSpecificMachine <em>Specific Machine</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProtocolConformanceImpl#getGeneralMachine <em>General Machine</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProtocolConformanceImpl extends DirectedRelationshipImpl implements ProtocolConformance {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getProtocolConformance();
	}
	...
	public ProtocolStateMachine getSpecificMachine() {
		if (eContainerFeatureID() != UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE) return null;
	...
	public NotificationChain basicSetSpecificMachine(ProtocolStateMachine newSpecificMachine, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSpecificMachine, UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE, msgs);
		return msgs;
	}
	...
	public void setSpecificMachine(ProtocolStateMachine newSpecificMachine) {
		if (newSpecificMachine != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE && newSpecificMachine != null)) {
			...
			if (newSpecificMachine != null)
				msgs = ((InternalEObject)newSpecificMachine).eInverseAdd(this, UML2WithIDPackage.PROTOCOL_STATE_MACHINE__CONFORMANCE, ProtocolStateMachine.class, msgs);
			msgs = basicSetSpecificMachine(newSpecificMachine, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE, newSpecificMachine, newSpecificMachine));
	}
		...
		if (generalMachine != null && generalMachine.eIsProxy()) {
			...
			if (generalMachine != oldGeneralMachine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.PROTOCOL_CONFORMANCE__GENERAL_MACHINE, oldGeneralMachine, generalMachine));
			}
		}
	...
	public void setGeneralMachine(ProtocolStateMachine newGeneralMachine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PROTOCOL_CONFORMANCE__GENERAL_MACHINE, oldGeneralMachine, generalMachine));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.PROTOCOL_STATE_MACHINE__CONFORMANCE, ProtocolStateMachine.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.PROTOCOL_CONFORMANCE__GENERAL_MACHINE:
