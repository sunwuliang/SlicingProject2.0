 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NamespaceImpl#getMember <em>Member</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NamespaceImpl#getOwnedRule <em>Owned Rule</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NamespaceImpl#getImportedMember <em>Imported Member</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NamespaceImpl#getElementImport <em>Element Import</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NamespaceImpl#getPackageImport <em>Package Import</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamespaceImpl extends NamedElementImpl implements Namespace {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getNamespace();
	}
	...
	public EList<NamedElement> getMember() {
		if (member == null) {
			member = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, UML2WithIDPackage.NAMESPACE__MEMBER);
		}
		return member;
	}
	...
	public EList<Constraint> getOwnedRule() {
		if (ownedRule == null) {
			ownedRule = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, UML2WithIDPackage.NAMESPACE__OWNED_RULE, UML2WithIDPackage.CONSTRAINT__NAMESPACE);
		}
		return ownedRule;
	}
	...
	public EList<PackageableElement> getImportedMember() {
		if (importedMember == null) {
			importedMember = new EObjectResolvingEList<PackageableElement>(PackageableElement.class, this, UML2WithIDPackage.NAMESPACE__IMPORTED_MEMBER);
		}
	...
	public EList<ElementImport> getElementImport() {
		if (elementImport == null) {
			elementImport = new EObjectContainmentWithInverseEList<ElementImport>(ElementImport.class, this, UML2WithIDPackage.NAMESPACE__ELEMENT_IMPORT, UML2WithIDPackage.ELEMENT_IMPORT__IMPORTING_NAMESPACE);
		}
	...
	public EList<PackageImport> getPackageImport() {
		if (packageImport == null) {
			packageImport = new EObjectContainmentWithInverseEList<PackageImport>(PackageImport.class, this, UML2WithIDPackage.NAMESPACE__PACKAGE_IMPORT, UML2WithIDPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.NAMESPACE__MEMBER:
				return getMember();
			case UML2WithIDPackage.NAMESPACE__OWNED_RULE:
				return getOwnedRule();
			case UML2WithIDPackage.NAMESPACE__IMPORTED_MEMBER:
