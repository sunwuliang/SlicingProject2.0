 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProtocolTransitionImpl#getPostCondition <em>Post Condition</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProtocolTransitionImpl#getReferred <em>Referred</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProtocolTransitionImpl#getPreCondition <em>Pre Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProtocolTransitionImpl extends TransitionImpl implements ProtocolTransition {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getProtocolTransition();
	}
	...
	public NotificationChain basicSetPostCondition(Constraint newPostCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PROTOCOL_TRANSITION__POST_CONDITION, oldPostCondition, newPostCondition);
	...
	public void setPostCondition(Constraint newPostCondition) {
		if (newPostCondition != postCondition) {
			...
			if (postCondition != null)
				msgs = ((InternalEObject)postCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.PROTOCOL_TRANSITION__POST_CONDITION, null, msgs);
			if (newPostCondition != null)
				msgs = ((InternalEObject)newPostCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.PROTOCOL_TRANSITION__POST_CONDITION, null, msgs);
			msgs = basicSetPostCondition(newPostCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PROTOCOL_TRANSITION__POST_CONDITION, newPostCondition, newPostCondition));
	}
	...
	public EList<Operation> getReferred() {
		if (referred == null) {
			referred = new EObjectResolvingEList<Operation>(Operation.class, this, UML2WithIDPackage.PROTOCOL_TRANSITION__REFERRED);
		}
		return referred;
	}
	...
	public Constraint getPreCondition() {
		if (preCondition != null && preCondition.eIsProxy()) {
			...
			if (preCondition != oldPreCondition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.PROTOCOL_TRANSITION__PRE_CONDITION, oldPreCondition, preCondition));
			}
		}
		return preCondition;
	}
	...
	public void setPreCondition(Constraint newPreCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PROTOCOL_TRANSITION__PRE_CONDITION, oldPreCondition, preCondition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.PROTOCOL_TRANSITION__POST_CONDITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.PROTOCOL_TRANSITION__REFERRED:
				return getReferred();
			case UML2WithIDPackage.PROTOCOL_TRANSITION__PRE_CONDITION:
