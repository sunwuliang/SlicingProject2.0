 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ContinuationImpl#isSetting <em>Setting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContinuationImpl extends InteractionFragmentImpl implements Continuation {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getContinuation();
	}
	...
	public void setSetting(boolean newSetting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.CONTINUATION__SETTING, oldSetting, setting));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.CONTINUATION__SETTING:
				return isSetting();
		}
