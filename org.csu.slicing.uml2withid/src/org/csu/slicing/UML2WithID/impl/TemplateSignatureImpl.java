 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateSignatureImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateSignatureImpl#getOwnedParameter <em>Owned Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateSignatureImpl#getNestedSignature <em>Nested Signature</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateSignatureImpl#getNestingSignature <em>Nesting Signature</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateSignatureImpl#getTemplate <em>Template</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateSignatureImpl extends ElementImpl implements TemplateSignature {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getTemplateSignature();
	}
	...
	public EList<TemplateParameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectResolvingEList<TemplateParameter>(TemplateParameter.class, this, UML2WithIDPackage.TEMPLATE_SIGNATURE__PARAMETER);
		}
		return parameter;
	}
	...
	public EList<TemplateParameter> getOwnedParameter() {
		if (ownedParameter == null) {
			ownedParameter = new EObjectContainmentWithInverseEList<TemplateParameter>(TemplateParameter.class, this, UML2WithIDPackage.TEMPLATE_SIGNATURE__OWNED_PARAMETER, UML2WithIDPackage.TEMPLATE_PARAMETER__SIGNATURE);
		}
	...
	public EList<TemplateSignature> getNestedSignature() {
		if (nestedSignature == null) {
			nestedSignature = new EObjectWithInverseResolvingEList<TemplateSignature>(TemplateSignature.class, this, UML2WithIDPackage.TEMPLATE_SIGNATURE__NESTED_SIGNATURE, UML2WithIDPackage.TEMPLATE_SIGNATURE__NESTING_SIGNATURE);
		}
		...
		if (nestingSignature != null && nestingSignature.eIsProxy()) {
			...
			if (nestingSignature != oldNestingSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.TEMPLATE_SIGNATURE__NESTING_SIGNATURE, oldNestingSignature, nestingSignature));
			}
		}
	...
	public NotificationChain basicSetNestingSignature(TemplateSignature newNestingSignature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TEMPLATE_SIGNATURE__NESTING_SIGNATURE, oldNestingSignature, newNestingSignature);
	...
	public void setNestingSignature(TemplateSignature newNestingSignature) {
		if (newNestingSignature != nestingSignature) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TEMPLATE_SIGNATURE__NESTING_SIGNATURE, newNestingSignature, newNestingSignature));
	}
	...
	public TemplateableElement getTemplate() {
		if (eContainerFeatureID() != UML2WithIDPackage.TEMPLATE_SIGNATURE__TEMPLATE) return null;
	...
	public NotificationChain basicSetTemplate(TemplateableElement newTemplate, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTemplate, UML2WithIDPackage.TEMPLATE_SIGNATURE__TEMPLATE, msgs);
		return msgs;
	}
	...
	public void setTemplate(TemplateableElement newTemplate) {
		if (newTemplate != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.TEMPLATE_SIGNATURE__TEMPLATE && newTemplate != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TEMPLATE_SIGNATURE__TEMPLATE, newTemplate, newTemplate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.TEMPLATE_SIGNATURE__PARAMETER:
				return getParameter();
			case UML2WithIDPackage.TEMPLATE_SIGNATURE__OWNED_PARAMETER:
