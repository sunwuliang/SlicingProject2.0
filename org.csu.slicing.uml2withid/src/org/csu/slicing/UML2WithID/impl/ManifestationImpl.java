 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ManifestationImpl#getUtilizedElement <em>Utilized Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ManifestationImpl extends AbstractionImpl implements Manifestation {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getManifestation();
	}
		...
		if (utilizedElement != null && utilizedElement.eIsProxy()) {
			...
			if (utilizedElement != oldUtilizedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.MANIFESTATION__UTILIZED_ELEMENT, oldUtilizedElement, utilizedElement));
			}
		}
	...
	public void setUtilizedElement(PackageableElement newUtilizedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.MANIFESTATION__UTILIZED_ELEMENT, oldUtilizedElement, utilizedElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.MANIFESTATION__UTILIZED_ELEMENT:
