 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.GeneralizationImpl#getSpecific <em>Specific</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.GeneralizationImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.GeneralizationImpl#isIsSubstitutable <em>Is Substitutable</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.GeneralizationImpl#getGeneralizationSet <em>Generalization Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationImpl extends DirectedRelationshipImpl implements Generalization {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getGeneralization();
	}
	...
	public Classifier getSpecific() {
		if (eContainerFeatureID() != UML2WithIDPackage.GENERALIZATION__SPECIFIC) return null;
	...
	public NotificationChain basicSetSpecific(Classifier newSpecific, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSpecific, UML2WithIDPackage.GENERALIZATION__SPECIFIC, msgs);
		return msgs;
	}
	...
	public void setSpecific(Classifier newSpecific) {
		if (newSpecific != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.GENERALIZATION__SPECIFIC && newSpecific != null)) {
			...
			if (newSpecific != null)
				msgs = ((InternalEObject)newSpecific).eInverseAdd(this, UML2WithIDPackage.CLASSIFIER__GENERALIZATION, Classifier.class, msgs);
			msgs = basicSetSpecific(newSpecific, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.GENERALIZATION__SPECIFIC, newSpecific, newSpecific));
	}
		...
		if (general != null && general.eIsProxy()) {
			...
			if (general != oldGeneral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.GENERALIZATION__GENERAL, oldGeneral, general));
			}
		}
		return general;
	}
	...
	public void setGeneral(Classifier newGeneral) {
		...
		general = newGeneral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.GENERALIZATION__GENERAL, oldGeneral, general));
	}
	...
	public void setIsSubstitutable(boolean newIsSubstitutable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.GENERALIZATION__IS_SUBSTITUTABLE, oldIsSubstitutable, isSubstitutable));
	}
	...
	public EList<GeneralizationSet> getGeneralizationSet() {
		if (generalizationSet == null) {
			generalizationSet = new EObjectWithInverseResolvingEList.ManyInverse<GeneralizationSet>(GeneralizationSet.class, this, UML2WithIDPackage.GENERALIZATION__GENERALIZATION_SET, UML2WithIDPackage.GENERALIZATION_SET__GENERALIZATION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.GENERALIZATION__SPECIFIC:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSpecific((Classifier)otherEnd, msgs);
			case UML2WithIDPackage.GENERALIZATION__GENERALIZATION_SET:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.GENERALIZATION__SPECIFIC:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.CLASSIFIER__GENERALIZATION, Classifier.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.GENERALIZATION__SPECIFIC:
				return getSpecific();
			case UML2WithIDPackage.GENERALIZATION__GENERAL:
				if (resolve) return getGeneral();
				return basicGetGeneral();
			case UML2WithIDPackage.GENERALIZATION__IS_SUBSTITUTABLE:
