 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DeploymentTargetImpl#getDeployment <em>Deployment</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DeploymentTargetImpl#getDeployedElement <em>Deployed Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DeploymentTargetImpl extends NamedElementImpl implements DeploymentTarget {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getDeploymentTarget();
	}
	...
	public EList<Deployment> getDeployment() {
		if (deployment == null) {
			deployment = new EObjectContainmentWithInverseEList<Deployment>(Deployment.class, this, UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYMENT, UML2WithIDPackage.DEPLOYMENT__LOCATION);
		}
		return deployment;
	}
	...
	public EList<PackageableElement> getDeployedElement() {
		if (deployedElement == null) {
			deployedElement = new EObjectResolvingEList<PackageableElement>(PackageableElement.class, this, UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYED_ELEMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYED_ELEMENT:
