 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TypeImpl#getPackage <em>Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypeImpl extends PackageableElementImpl implements Type {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getType();
	}
		...
		if (package_ != null && package_.eIsProxy()) {
			...
			if (package_ != oldPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.TYPE__PACKAGE, oldPackage, package_));
			}
		}
		return package_;
	}
	...
	public NotificationChain basicSetPackage(org.csu.slicing.UML2WithID.Package newPackage, NotificationChain msgs) {
		...
		package_ = newPackage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TYPE__PACKAGE, oldPackage, newPackage);
	...
	public void setPackage(org.csu.slicing.UML2WithID.Package newPackage) {
		if (newPackage != package_) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TYPE__PACKAGE, newPackage, newPackage));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.TYPE__PACKAGE:
				if (package_ != null)
					msgs = ((InternalEObject)package_).eInverseRemove(this, UML2WithIDPackage.PACKAGE__OWNED_TYPE, org.csu.slicing.UML2WithID.Package.class, msgs);
