 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.InteractionOccurrenceImpl#getRefersTo <em>Refers To</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.InteractionOccurrenceImpl#getActualGate <em>Actual Gate</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.InteractionOccurrenceImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InteractionOccurrenceImpl extends InteractionFragmentImpl implements InteractionOccurrence {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getInteractionOccurrence();
	}
		...
		if (refersTo != null && refersTo.eIsProxy()) {
			...
			if (refersTo != oldRefersTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.INTERACTION_OCCURRENCE__REFERS_TO, oldRefersTo, refersTo));
			}
		}
		return refersTo;
	}
	...
	public void setRefersTo(Interaction newRefersTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.INTERACTION_OCCURRENCE__REFERS_TO, oldRefersTo, refersTo));
	}
	...
	public EList<Gate> getActualGate() {
		if (actualGate == null) {
			actualGate = new EObjectContainmentEList<Gate>(Gate.class, this, UML2WithIDPackage.INTERACTION_OCCURRENCE__ACTUAL_GATE);
		}
		return actualGate;
	}
	...
	public EList<InputPin> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<InputPin>(InputPin.class, this, UML2WithIDPackage.INTERACTION_OCCURRENCE__ARGUMENT);
		}
		return argument;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.INTERACTION_OCCURRENCE__ACTUAL_GATE:
				return ((InternalEList<?>)getActualGate()).basicRemove(otherEnd, msgs);
			case UML2WithIDPackage.INTERACTION_OCCURRENCE__ARGUMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.INTERACTION_OCCURRENCE__REFERS_TO:
