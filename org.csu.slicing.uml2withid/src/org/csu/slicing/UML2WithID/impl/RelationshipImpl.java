 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.RelationshipImpl#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RelationshipImpl extends ElementImpl implements Relationship {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getRelationship();
	}
	...
	public EList<Element> getRelatedElement() {
		if (relatedElement == null) {
			relatedElement = new EObjectResolvingEList<Element>(Element.class, this, UML2WithIDPackage.RELATIONSHIP__RELATED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.RELATIONSHIP__RELATED_ELEMENT:
