 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StructuredClassifierImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StructuredClassifierImpl#getPart <em>Part</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StructuredClassifierImpl#getRole <em>Role</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StructuredClassifierImpl#getOwnedConnector <em>Owned Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuredClassifierImpl extends ClassifierImpl implements StructuredClassifier {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getStructuredClassifier();
	}
	...
	public EList<Property> getOwnedAttribute() {
		if (ownedAttribute == null) {
			ownedAttribute = new EObjectContainmentEList<Property>(Property.class, this, UML2WithIDPackage.STRUCTURED_CLASSIFIER__OWNED_ATTRIBUTE);
		}
	...
	public EList<Property> getPart() {
		if (part == null) {
			part = new EObjectResolvingEList<Property>(Property.class, this, UML2WithIDPackage.STRUCTURED_CLASSIFIER__PART);
		}
		return part;
	}
	...
	public EList<ConnectableElement> getRole() {
		if (role == null) {
			role = new EObjectResolvingEList<ConnectableElement>(ConnectableElement.class, this, UML2WithIDPackage.STRUCTURED_CLASSIFIER__ROLE);
		}
		return role;
	}
	...
	public EList<Connector> getOwnedConnector() {
		if (ownedConnector == null) {
			ownedConnector = new EObjectContainmentEList<Connector>(Connector.class, this, UML2WithIDPackage.STRUCTURED_CLASSIFIER__OWNED_CONNECTOR);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.STRUCTURED_CLASSIFIER__OWNED_ATTRIBUTE:
				return ((InternalEList<?>)getOwnedAttribute()).basicRemove(otherEnd, msgs);
			case UML2WithIDPackage.STRUCTURED_CLASSIFIER__OWNED_CONNECTOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.STRUCTURED_CLASSIFIER__PART:
				return getPart();
			case UML2WithIDPackage.STRUCTURED_CLASSIFIER__ROLE:
				return getRole();
			case UML2WithIDPackage.STRUCTURED_CLASSIFIER__OWNED_CONNECTOR:
