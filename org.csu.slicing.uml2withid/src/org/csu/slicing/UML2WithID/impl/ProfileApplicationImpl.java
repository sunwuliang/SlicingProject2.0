 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProfileApplicationImpl#getImportedProfile <em>Imported Profile</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProfileApplicationImpl extends PackageImportImpl implements ProfileApplication {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getProfileApplication();
	}
		...
		if (importedProfile != null && importedProfile.eIsProxy()) {
			...
			if (importedProfile != oldImportedProfile) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.PROFILE_APPLICATION__IMPORTED_PROFILE, oldImportedProfile, importedProfile));
			}
		}
	...
	public void setImportedProfile(Profile newImportedProfile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PROFILE_APPLICATION__IMPORTED_PROFILE, oldImportedProfile, importedProfile));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.PROFILE_APPLICATION__IMPORTED_PROFILE:
