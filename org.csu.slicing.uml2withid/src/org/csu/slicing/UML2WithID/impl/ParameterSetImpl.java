 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ParameterSetImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ParameterSetImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterSetImpl extends NamedElementImpl implements ParameterSet {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getParameterSet();
	}
	...
	public EList<Parameter> getParameter() {
		if (parameter == null) {
			parameter = new EObjectWithInverseResolvingEList.ManyInverse<Parameter>(Parameter.class, this, UML2WithIDPackage.PARAMETER_SET__PARAMETER, UML2WithIDPackage.PARAMETER__PARAMETER_SET);
		}
		return parameter;
	}
	...
	public EList<Constraint> getCondition() {
		if (condition == null) {
			condition = new EObjectContainmentEList<Constraint>(Constraint.class, this, UML2WithIDPackage.PARAMETER_SET__CONDITION);
		}
		return condition;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.PARAMETER_SET__PARAMETER:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.PARAMETER_SET__CONDITION:
