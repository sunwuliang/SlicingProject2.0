 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ProtocolStateMachineImpl#getConformance <em>Conformance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProtocolStateMachineImpl extends StateMachineImpl implements ProtocolStateMachine {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getProtocolStateMachine();
	}
	...
	public EList<ProtocolConformance> getConformance() {
		if (conformance == null) {
			conformance = new EObjectContainmentWithInverseEList<ProtocolConformance>(ProtocolConformance.class, this, UML2WithIDPackage.PROTOCOL_STATE_MACHINE__CONFORMANCE, UML2WithIDPackage.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE);
		}
		return conformance;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.PROTOCOL_STATE_MACHINE__CONFORMANCE:
