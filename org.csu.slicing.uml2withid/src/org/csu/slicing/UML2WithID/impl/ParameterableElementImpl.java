 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ParameterableElementImpl#getTemplateParameter <em>Template Parameter</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ParameterableElementImpl#getOwningParameter <em>Owning Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ParameterableElementImpl extends ElementImpl implements ParameterableElement {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getParameterableElement();
	}
		...
		if (templateParameter != null && templateParameter.eIsProxy()) {
			...
			if (templateParameter != oldTemplateParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER, oldTemplateParameter, templateParameter));
			}
		}
	...
	public NotificationChain basicSetTemplateParameter(TemplateParameter newTemplateParameter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER, oldTemplateParameter, newTemplateParameter);
	...
	public void setTemplateParameter(TemplateParameter newTemplateParameter) {
		if (newTemplateParameter != templateParameter) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER, newTemplateParameter, newTemplateParameter));
	}
	...
	public TemplateParameter getOwningParameter() {
		if (eContainerFeatureID() != UML2WithIDPackage.PARAMETERABLE_ELEMENT__OWNING_PARAMETER) return null;
	...
	public NotificationChain basicSetOwningParameter(TemplateParameter newOwningParameter, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningParameter, UML2WithIDPackage.PARAMETERABLE_ELEMENT__OWNING_PARAMETER, msgs);
		return msgs;
	}
	...
	public void setOwningParameter(TemplateParameter newOwningParameter) {
		if (newOwningParameter != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.PARAMETERABLE_ELEMENT__OWNING_PARAMETER && newOwningParameter != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PARAMETERABLE_ELEMENT__OWNING_PARAMETER, newOwningParameter, newOwningParameter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.PARAMETERABLE_ELEMENT__TEMPLATE_PARAMETER:
				if (templateParameter != null)
					msgs = ((InternalEObject)templateParameter).eInverseRemove(this, UML2WithIDPackage.TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, TemplateParameter.class, msgs);
				return basicSetTemplateParameter((TemplateParameter)otherEnd, msgs);
			case UML2WithIDPackage.PARAMETERABLE_ELEMENT__OWNING_PARAMETER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
