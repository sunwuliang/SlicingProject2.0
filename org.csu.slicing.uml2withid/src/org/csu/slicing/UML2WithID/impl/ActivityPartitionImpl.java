 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getSuperGroup <em>Super Group</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getActivityGroup_activity <em>Activity Group activity</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#isIsDimension <em>Is Dimension</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#isIsExternal <em>Is External</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getContainedEdge <em>Contained Edge</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getContainedNode <em>Contained Node</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getSubgroup <em>Subgroup</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getSuperPartition <em>Super Partition</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ActivityPartitionImpl#getRepresents <em>Represents</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityPartitionImpl extends NamedElementImpl implements ActivityPartition {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getActivityPartition();
	}
		...
		if (superGroup != null && superGroup.eIsProxy()) {
			...
			if (superGroup != oldSuperGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_GROUP, oldSuperGroup, superGroup));
			}
		}
		return superGroup;
	}
	...
	public void setSuperGroup(ActivityGroup newSuperGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_GROUP, oldSuperGroup, superGroup));
	}
	...
	public Activity getActivityGroup_activity() {
		if (eContainerFeatureID() != UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY) return null;
	...
	public NotificationChain basicSetActivityGroup_activity(Activity newActivityGroup_activity, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newActivityGroup_activity, UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY, msgs);
		return msgs;
	}
	...
	public void setActivityGroup_activity(Activity newActivityGroup_activity) {
		if (newActivityGroup_activity != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY && newActivityGroup_activity != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY, newActivityGroup_activity, newActivityGroup_activity));
	}
	...
	public void setIsDimension(boolean newIsDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ACTIVITY_PARTITION__IS_DIMENSION, oldIsDimension, isDimension));
	}
	...
	public void setIsExternal(boolean newIsExternal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ACTIVITY_PARTITION__IS_EXTERNAL, oldIsExternal, isExternal));
	}
	...
	public EList<ActivityEdge> getContainedEdge() {
		if (containedEdge == null) {
			containedEdge = new EObjectWithInverseResolvingEList.ManyInverse<ActivityEdge>(ActivityEdge.class, this, UML2WithIDPackage.ACTIVITY_PARTITION__CONTAINED_EDGE, UML2WithIDPackage.ACTIVITY_EDGE__IN_PARTITION);
		}
	...
	public EList<ActivityNode> getContainedNode() {
		if (containedNode == null) {
			containedNode = new EObjectWithInverseResolvingEList.ManyInverse<ActivityNode>(ActivityNode.class, this, UML2WithIDPackage.ACTIVITY_PARTITION__CONTAINED_NODE, UML2WithIDPackage.ACTIVITY_NODE__IN_PARTITION);
		}
	...
	public EList<ActivityPartition> getSubgroup() {
		if (subgroup == null) {
			subgroup = new EObjectContainmentWithInverseEList<ActivityPartition>(ActivityPartition.class, this, UML2WithIDPackage.ACTIVITY_PARTITION__SUBGROUP, UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_PARTITION);
		}
		return subgroup;
	}
	...
	public ActivityPartition getSuperPartition() {
		if (eContainerFeatureID() != UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_PARTITION) return null;
	...
	public NotificationChain basicSetSuperPartition(ActivityPartition newSuperPartition, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSuperPartition, UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_PARTITION, msgs);
		return msgs;
	}
	...
	public void setSuperPartition(ActivityPartition newSuperPartition) {
		if (newSuperPartition != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_PARTITION && newSuperPartition != null)) {
			...
			if (newSuperPartition != null)
				msgs = ((InternalEObject)newSuperPartition).eInverseAdd(this, UML2WithIDPackage.ACTIVITY_PARTITION__SUBGROUP, ActivityPartition.class, msgs);
			msgs = basicSetSuperPartition(newSuperPartition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_PARTITION, newSuperPartition, newSuperPartition));
	}
	...
	public Element getRepresents() {
		if (represents != null && represents.eIsProxy()) {
			...
			if (represents != oldRepresents) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.ACTIVITY_PARTITION__REPRESENTS, oldRepresents, represents));
			}
		}
		return represents;
	}
	...
	public void setRepresents(Element newRepresents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ACTIVITY_PARTITION__REPRESENTS, oldRepresents, represents));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			...
			case UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_PARTITION:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.ACTIVITY_PARTITION__SUBGROUP, ActivityPartition.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_GROUP:
				if (resolve) return getSuperGroup();
				return basicGetSuperGroup();
			case UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY:
				return getActivityGroup_activity();
			case UML2WithIDPackage.ACTIVITY_PARTITION__IS_DIMENSION:
				return isIsDimension();
			case UML2WithIDPackage.ACTIVITY_PARTITION__IS_EXTERNAL:
				return isIsExternal();
			case UML2WithIDPackage.ACTIVITY_PARTITION__CONTAINED_EDGE:
			...
			case UML2WithIDPackage.ACTIVITY_PARTITION__REPRESENTS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ActivityGroup.class) {
			switch (derivedFeatureID) {
				case UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_GROUP: return UML2WithIDPackage.ACTIVITY_GROUP__SUPER_GROUP;
				case UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY: return UML2WithIDPackage.ACTIVITY_GROUP__ACTIVITY_GROUP_ACTIVITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ActivityGroup.class) {
			switch (baseFeatureID) {
				case UML2WithIDPackage.ACTIVITY_GROUP__SUPER_GROUP: return UML2WithIDPackage.ACTIVITY_PARTITION__SUPER_GROUP;
				case UML2WithIDPackage.ACTIVITY_GROUP__ACTIVITY_GROUP_ACTIVITY: return UML2WithIDPackage.ACTIVITY_PARTITION__ACTIVITY_GROUP_ACTIVITY;
				default: return -1;
			}
		}
