 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LiteralIntegerImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralIntegerImpl extends LiteralSpecificationImpl implements LiteralInteger {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getLiteralInteger();
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LITERAL_INTEGER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.LITERAL_INTEGER__VALUE:
				return getValue();
		}
