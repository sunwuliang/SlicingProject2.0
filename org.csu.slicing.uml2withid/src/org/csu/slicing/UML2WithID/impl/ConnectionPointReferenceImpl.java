 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ConnectionPointReferenceImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ConnectionPointReferenceImpl#getExit <em>Exit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectionPointReferenceImpl extends VertexImpl implements ConnectionPointReference {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getConnectionPointReference();
	}
	...
	public EList<Pseudostate> getEntry() {
		if (entry == null) {
			entry = new EObjectResolvingEList<Pseudostate>(Pseudostate.class, this, UML2WithIDPackage.CONNECTION_POINT_REFERENCE__ENTRY);
		}
		return entry;
	}
	...
	public EList<Pseudostate> getExit() {
		if (exit == null) {
			exit = new EObjectResolvingEList<Pseudostate>(Pseudostate.class, this, UML2WithIDPackage.CONNECTION_POINT_REFERENCE__EXIT);
		}
		return exit;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.CONNECTION_POINT_REFERENCE__ENTRY:
				return getEntry();
			case UML2WithIDPackage.CONNECTION_POINT_REFERENCE__EXIT:
				return getExit();
		}
