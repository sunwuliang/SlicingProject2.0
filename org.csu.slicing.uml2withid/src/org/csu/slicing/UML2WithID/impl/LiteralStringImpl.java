 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LiteralStringImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralStringImpl extends LiteralSpecificationImpl implements LiteralString {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getLiteralString();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LITERAL_STRING__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.LITERAL_STRING__VALUE:
				return getValue();
		}
