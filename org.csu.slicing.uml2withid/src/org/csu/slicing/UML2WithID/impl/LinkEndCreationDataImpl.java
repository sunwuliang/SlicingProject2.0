 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LinkEndCreationDataImpl#isIsReplaceAll <em>Is Replace All</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LinkEndCreationDataImpl#getInsertAt <em>Insert At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkEndCreationDataImpl extends LinkEndDataImpl implements LinkEndCreationData {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getLinkEndCreationData();
	}
	...
	public void setIsReplaceAll(boolean newIsReplaceAll) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LINK_END_CREATION_DATA__IS_REPLACE_ALL, oldIsReplaceAll, isReplaceAll));
	}
	...
	public InputPin getInsertAt() {
		if (insertAt != null && insertAt.eIsProxy()) {
			...
			if (insertAt != oldInsertAt) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.LINK_END_CREATION_DATA__INSERT_AT, oldInsertAt, insertAt));
			}
		}
		return insertAt;
	}
	...
	public void setInsertAt(InputPin newInsertAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LINK_END_CREATION_DATA__INSERT_AT, oldInsertAt, insertAt));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.LINK_END_CREATION_DATA__IS_REPLACE_ALL:
				return isIsReplaceAll();
			case UML2WithIDPackage.LINK_END_CREATION_DATA__INSERT_AT:
