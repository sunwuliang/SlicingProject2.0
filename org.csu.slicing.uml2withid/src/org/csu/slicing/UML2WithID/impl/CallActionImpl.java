 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.CallActionImpl#isIsSynchronous <em>Is Synchronous</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.CallActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CallActionImpl extends InvocationActionImpl implements CallAction {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getCallAction();
	}
	...
	public void setIsSynchronous(boolean newIsSynchronous) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.CALL_ACTION__IS_SYNCHRONOUS, oldIsSynchronous, isSynchronous));
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, UML2WithIDPackage.CALL_ACTION__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.CALL_ACTION__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.CALL_ACTION__IS_SYNCHRONOUS:
