 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.SlotImpl#getOwningInstance <em>Owning Instance</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.SlotImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.SlotImpl#getDefiningFeature <em>Defining Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlotImpl extends ElementImpl implements Slot {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getSlot();
	}
	...
	public InstanceSpecification getOwningInstance() {
		if (eContainerFeatureID() != UML2WithIDPackage.SLOT__OWNING_INSTANCE) return null;
	...
	public NotificationChain basicSetOwningInstance(InstanceSpecification newOwningInstance, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningInstance, UML2WithIDPackage.SLOT__OWNING_INSTANCE, msgs);
		return msgs;
	}
	...
	public void setOwningInstance(InstanceSpecification newOwningInstance) {
		if (newOwningInstance != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.SLOT__OWNING_INSTANCE && newOwningInstance != null)) {
			...
			if (newOwningInstance != null)
				msgs = ((InternalEObject)newOwningInstance).eInverseAdd(this, UML2WithIDPackage.INSTANCE_SPECIFICATION__SLOT, InstanceSpecification.class, msgs);
			msgs = basicSetOwningInstance(newOwningInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.SLOT__OWNING_INSTANCE, newOwningInstance, newOwningInstance));
	}
	...
	public EList<ValueSpecification> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, UML2WithIDPackage.SLOT__VALUE);
		}
		return value;
	}
		...
		if (definingFeature != null && definingFeature.eIsProxy()) {
			...
			if (definingFeature != oldDefiningFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.SLOT__DEFINING_FEATURE, oldDefiningFeature, definingFeature));
			}
		}
	...
	public void setDefiningFeature(StructuralFeature newDefiningFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.SLOT__DEFINING_FEATURE, oldDefiningFeature, definingFeature));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.SLOT__OWNING_INSTANCE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.SLOT__VALUE:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.SLOT__OWNING_INSTANCE:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.INSTANCE_SPECIFICATION__SLOT, InstanceSpecification.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.SLOT__VALUE:
				return getValue();
			case UML2WithIDPackage.SLOT__DEFINING_FEATURE:
