 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ComponentImpl#isIsIndirectlyInstantiated <em>Is Indirectly Instantiated</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ComponentImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ComponentImpl#getProvided <em>Provided</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ComponentImpl#getRealization <em>Realization</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ComponentImpl#getOwnedMember <em>Owned Member</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentImpl extends ClassImpl implements Component {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getComponent();
	}
	...
	public void setIsIndirectlyInstantiated(boolean newIsIndirectlyInstantiated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.COMPONENT__IS_INDIRECTLY_INSTANTIATED, oldIsIndirectlyInstantiated, isIndirectlyInstantiated));
	}
	...
	public EList<Interface> getRequired() {
		if (required == null) {
			required = new EObjectResolvingEList<Interface>(Interface.class, this, UML2WithIDPackage.COMPONENT__REQUIRED);
		}
		return required;
	}
	...
	public EList<Interface> getProvided() {
		if (provided == null) {
			provided = new EObjectResolvingEList<Interface>(Interface.class, this, UML2WithIDPackage.COMPONENT__PROVIDED);
		}
		return provided;
	}
	...
	public EList<Realization> getRealization() {
		if (realization == null) {
			realization = new EObjectContainmentWithInverseEList<Realization>(Realization.class, this, UML2WithIDPackage.COMPONENT__REALIZATION, UML2WithIDPackage.REALIZATION__ABSTRACTION);
		}
		return realization;
	}
	...
	public EList<PackageableElement> getOwnedMember() {
		if (ownedMember == null) {
			ownedMember = new EObjectContainmentEList<PackageableElement>(PackageableElement.class, this, UML2WithIDPackage.COMPONENT__OWNED_MEMBER);
		}
		return ownedMember;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.COMPONENT__REALIZATION:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.COMPONENT__OWNED_MEMBER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.COMPONENT__IS_INDIRECTLY_INSTANTIATED:
				return isIsIndirectlyInstantiated();
			case UML2WithIDPackage.COMPONENT__REQUIRED:
				return getRequired();
			case UML2WithIDPackage.COMPONENT__PROVIDED:
				return getProvided();
			case UML2WithIDPackage.COMPONENT__REALIZATION:
