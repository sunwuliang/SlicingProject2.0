 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.BehavioredClassifierImpl#getOwnedBehavior <em>Owned Behavior</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.BehavioredClassifierImpl#getClassifierBehavior <em>Classifier Behavior</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.BehavioredClassifierImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.BehavioredClassifierImpl#getOwnedTrigger <em>Owned Trigger</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.BehavioredClassifierImpl#getOwnedStateMachine <em>Owned State Machine</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BehavioredClassifierImpl extends ClassifierImpl implements BehavioredClassifier {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getBehavioredClassifier();
	}
	...
	public EList<Behavior> getOwnedBehavior() {
		if (ownedBehavior == null) {
			ownedBehavior = new EObjectContainmentWithInverseEList<Behavior>(Behavior.class, this, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR, UML2WithIDPackage.BEHAVIOR__CONTEXT);
		}
		...
		if (classifierBehavior != null && classifierBehavior.eIsProxy()) {
			...
			if (classifierBehavior != oldClassifierBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR, oldClassifierBehavior, classifierBehavior));
			}
		}
	...
	public void setClassifierBehavior(Behavior newClassifierBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR, oldClassifierBehavior, classifierBehavior));
	}
	...
	public EList<Implementation> getImplementation() {
		if (implementation == null) {
			implementation = new EObjectContainmentWithInverseEList<Implementation>(Implementation.class, this, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__IMPLEMENTATION, UML2WithIDPackage.IMPLEMENTATION__IMPLEMENTING_CLASSIFIER);
		}
	...
	public EList<Trigger> getOwnedTrigger() {
		if (ownedTrigger == null) {
			ownedTrigger = new EObjectContainmentEList<Trigger>(Trigger.class, this, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_TRIGGER);
		}
		return ownedTrigger;
	}
	...
	public EList<StateMachine> getOwnedStateMachine() {
		if (ownedStateMachine == null) {
			ownedStateMachine = new EObjectContainmentWithInverseEList<StateMachine>(StateMachine.class, this, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_STATE_MACHINE, UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getOwnedBehavior()).basicAdd(otherEnd, msgs);
			case UML2WithIDPackage.BEHAVIORED_CLASSIFIER__IMPLEMENTATION:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getImplementation()).basicAdd(otherEnd, msgs);
			case UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_STATE_MACHINE:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_TRIGGER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR:
