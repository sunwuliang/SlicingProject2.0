 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.FeatureImpl#getFeaturingClassifier <em>Featuring Classifier</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.FeatureImpl#isIsStatic <em>Is Static</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FeatureImpl extends RedefinableElementImpl implements Feature {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getFeature();
	}
	...
	public EList<Classifier> getFeaturingClassifier() {
		if (featuringClassifier == null) {
			featuringClassifier = new EObjectWithInverseResolvingEList.ManyInverse<Classifier>(Classifier.class, this, UML2WithIDPackage.FEATURE__FEATURING_CLASSIFIER, UML2WithIDPackage.CLASSIFIER__FEATURE);
		}
	...
	public void setIsStatic(boolean newIsStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.FEATURE__IS_STATIC, oldIsStatic, isStatic));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.FEATURE__FEATURING_CLASSIFIER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.FEATURE__IS_STATIC:
				return isIsStatic();
		}
