 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ApplyFunctionActionImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ApplyFunctionActionImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ApplyFunctionActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplyFunctionActionImpl extends ActionImpl implements ApplyFunctionAction {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getApplyFunctionAction();
	}
		...
		if (function != null && function.eIsProxy()) {
			...
			if (function != oldFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.APPLY_FUNCTION_ACTION__FUNCTION, oldFunction, function));
			}
		}
		return function;
	}
	...
	public void setFunction(PrimitiveFunction newFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.APPLY_FUNCTION_ACTION__FUNCTION, oldFunction, function));
	}
	...
	public EList<InputPin> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<InputPin>(InputPin.class, this, UML2WithIDPackage.APPLY_FUNCTION_ACTION__ARGUMENT);
		}
		return argument;
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, UML2WithIDPackage.APPLY_FUNCTION_ACTION__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.APPLY_FUNCTION_ACTION__ARGUMENT:
				return ((InternalEList<?>)getArgument()).basicRemove(otherEnd, msgs);
			case UML2WithIDPackage.APPLY_FUNCTION_ACTION__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.APPLY_FUNCTION_ACTION__FUNCTION:
