 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.RaiseExceptionActionImpl#getException <em>Exception</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RaiseExceptionActionImpl extends ActionImpl implements RaiseExceptionAction {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getRaiseExceptionAction();
	}
		...
		if (exception != null && exception.eIsProxy()) {
			...
			if (exception != oldException) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.RAISE_EXCEPTION_ACTION__EXCEPTION, oldException, exception));
			}
		}
		return exception;
	}
	...
	public void setException(InputPin newException) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.RAISE_EXCEPTION_ACTION__EXCEPTION, oldException, exception));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.RAISE_EXCEPTION_ACTION__EXCEPTION:
