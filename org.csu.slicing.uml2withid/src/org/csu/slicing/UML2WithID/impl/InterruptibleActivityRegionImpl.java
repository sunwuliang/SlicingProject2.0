 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.InterruptibleActivityRegionImpl#getInterruptingEdge <em>Interrupting Edge</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.InterruptibleActivityRegionImpl#getContainedNode <em>Contained Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterruptibleActivityRegionImpl extends ActivityGroupImpl implements InterruptibleActivityRegion {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getInterruptibleActivityRegion();
	}
	...
	public EList<ActivityEdge> getInterruptingEdge() {
		if (interruptingEdge == null) {
			interruptingEdge = new EObjectWithInverseResolvingEList<ActivityEdge>(ActivityEdge.class, this, UML2WithIDPackage.INTERRUPTIBLE_ACTIVITY_REGION__INTERRUPTING_EDGE, UML2WithIDPackage.ACTIVITY_EDGE__INTERRUPTS);
		}
	...
	public EList<ActivityNode> getContainedNode() {
		if (containedNode == null) {
			containedNode = new EObjectWithInverseResolvingEList.ManyInverse<ActivityNode>(ActivityNode.class, this, UML2WithIDPackage.INTERRUPTIBLE_ACTIVITY_REGION__CONTAINED_NODE, UML2WithIDPackage.ACTIVITY_NODE__IN_INTERRUPTIBLE_REGION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.INTERRUPTIBLE_ACTIVITY_REGION__INTERRUPTING_EDGE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInterruptingEdge()).basicAdd(otherEnd, msgs);
			case UML2WithIDPackage.INTERRUPTIBLE_ACTIVITY_REGION__CONTAINED_NODE:
