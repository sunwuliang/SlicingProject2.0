 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DestroyObjectActionImpl#isIsDestroyLinks <em>Is Destroy Links</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DestroyObjectActionImpl#isIsDestroyOwnedObjects <em>Is Destroy Owned Objects</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DestroyObjectActionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DestroyObjectActionImpl extends ActionImpl implements DestroyObjectAction {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getDestroyObjectAction();
	}
	...
	public void setIsDestroyLinks(boolean newIsDestroyLinks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.DESTROY_OBJECT_ACTION__IS_DESTROY_LINKS, oldIsDestroyLinks, isDestroyLinks));
	}
	...
	public void setIsDestroyOwnedObjects(boolean newIsDestroyOwnedObjects) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.DESTROY_OBJECT_ACTION__IS_DESTROY_OWNED_OBJECTS, oldIsDestroyOwnedObjects, isDestroyOwnedObjects));
	}
	...
	public NotificationChain basicSetTarget(InputPin newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.DESTROY_OBJECT_ACTION__TARGET, oldTarget, newTarget);
	...
	public void setTarget(InputPin newTarget) {
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.DESTROY_OBJECT_ACTION__TARGET, null, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.DESTROY_OBJECT_ACTION__TARGET, null, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.DESTROY_OBJECT_ACTION__TARGET, newTarget, newTarget));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.DESTROY_OBJECT_ACTION__TARGET:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.DESTROY_OBJECT_ACTION__IS_DESTROY_LINKS:
				return isIsDestroyLinks();
			case UML2WithIDPackage.DESTROY_OBJECT_ACTION__IS_DESTROY_OWNED_OBJECTS:
