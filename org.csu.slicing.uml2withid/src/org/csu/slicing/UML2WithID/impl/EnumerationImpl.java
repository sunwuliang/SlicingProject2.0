 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getEnumeration();
	}
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, UML2WithIDPackage.ENUMERATION__OWNED_LITERAL, UML2WithIDPackage.ENUMERATION_LITERAL__ENUMERATION);
		}
		return ownedLiteral;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.ENUMERATION__OWNED_LITERAL:
