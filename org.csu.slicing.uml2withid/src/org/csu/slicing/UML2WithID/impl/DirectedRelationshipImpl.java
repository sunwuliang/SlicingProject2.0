 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DirectedRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DirectedRelationshipImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DirectedRelationshipImpl extends RelationshipImpl implements DirectedRelationship {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getDirectedRelationship();
	}
	...
	public EList<Element> getSource() {
		if (source == null) {
			source = new EObjectResolvingEList<Element>(Element.class, this, UML2WithIDPackage.DIRECTED_RELATIONSHIP__SOURCE);
		}
		return source;
	}
	...
	public EList<Element> getTarget() {
		if (target == null) {
			target = new EObjectResolvingEList<Element>(Element.class, this, UML2WithIDPackage.DIRECTED_RELATIONSHIP__TARGET);
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.DIRECTED_RELATIONSHIP__SOURCE:
				return getSource();
			case UML2WithIDPackage.DIRECTED_RELATIONSHIP__TARGET:
				return getTarget();
		}
