 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.QualifierValueImpl#getQualifier <em>Qualifier</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.QualifierValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QualifierValueImpl extends ElementImpl implements QualifierValue {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getQualifierValue();
	}
		...
		if (qualifier != null && qualifier.eIsProxy()) {
			...
			if (qualifier != oldQualifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.QUALIFIER_VALUE__QUALIFIER, oldQualifier, qualifier));
			}
		}
		return qualifier;
	}
	...
	public void setQualifier(Property newQualifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.QUALIFIER_VALUE__QUALIFIER, oldQualifier, qualifier));
	}
	...
	public InputPin getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.QUALIFIER_VALUE__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setValue(InputPin newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.QUALIFIER_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.QUALIFIER_VALUE__QUALIFIER:
				if (resolve) return getQualifier();
				return basicGetQualifier();
			case UML2WithIDPackage.QUALIFIER_VALUE__VALUE:
