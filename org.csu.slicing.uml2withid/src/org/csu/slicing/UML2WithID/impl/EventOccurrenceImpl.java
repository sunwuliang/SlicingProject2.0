 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EventOccurrenceImpl#getReceiveMessage <em>Receive Message</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EventOccurrenceImpl#getSendMessage <em>Send Message</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EventOccurrenceImpl#getStartExec <em>Start Exec</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EventOccurrenceImpl#getFinishExec <em>Finish Exec</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EventOccurrenceImpl#getToAfter <em>To After</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EventOccurrenceImpl#getToBefore <em>To Before</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventOccurrenceImpl extends InteractionFragmentImpl implements EventOccurrence {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getEventOccurrence();
	}
		...
		if (receiveMessage != null && receiveMessage.eIsProxy()) {
			...
			if (receiveMessage != oldReceiveMessage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.EVENT_OCCURRENCE__RECEIVE_MESSAGE, oldReceiveMessage, receiveMessage));
			}
		}
	...
	public NotificationChain basicSetReceiveMessage(Message newReceiveMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.EVENT_OCCURRENCE__RECEIVE_MESSAGE, oldReceiveMessage, newReceiveMessage);
	...
	public void setReceiveMessage(Message newReceiveMessage) {
		if (newReceiveMessage != receiveMessage) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.EVENT_OCCURRENCE__RECEIVE_MESSAGE, newReceiveMessage, newReceiveMessage));
	}
	...
	public Message getSendMessage() {
		if (sendMessage != null && sendMessage.eIsProxy()) {
			...
			if (sendMessage != oldSendMessage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.EVENT_OCCURRENCE__SEND_MESSAGE, oldSendMessage, sendMessage));
			}
		}
		return sendMessage;
	}
	...
	public NotificationChain basicSetSendMessage(Message newSendMessage, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.EVENT_OCCURRENCE__SEND_MESSAGE, oldSendMessage, newSendMessage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSendMessage(Message newSendMessage) {
		if (newSendMessage != sendMessage) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.EVENT_OCCURRENCE__SEND_MESSAGE, newSendMessage, newSendMessage));
	}
	...
	public EList<ExecutionOccurrence> getStartExec() {
		if (startExec == null) {
			startExec = new EObjectWithInverseResolvingEList<ExecutionOccurrence>(ExecutionOccurrence.class, this, UML2WithIDPackage.EVENT_OCCURRENCE__START_EXEC, UML2WithIDPackage.EXECUTION_OCCURRENCE__START);
		}
		return startExec;
	}
	...
	public EList<ExecutionOccurrence> getFinishExec() {
		if (finishExec == null) {
			finishExec = new EObjectWithInverseResolvingEList<ExecutionOccurrence>(ExecutionOccurrence.class, this, UML2WithIDPackage.EVENT_OCCURRENCE__FINISH_EXEC, UML2WithIDPackage.EXECUTION_OCCURRENCE__FINISH);
		}
		return finishExec;
	}
	...
	public EList<GeneralOrdering> getToAfter() {
		if (toAfter == null) {
			toAfter = new EObjectWithInverseResolvingEList<GeneralOrdering>(GeneralOrdering.class, this, UML2WithIDPackage.EVENT_OCCURRENCE__TO_AFTER, UML2WithIDPackage.GENERAL_ORDERING__BEFORE);
		}
		return toAfter;
	}
	...
	public EList<GeneralOrdering> getToBefore() {
		if (toBefore == null) {
			toBefore = new EObjectWithInverseResolvingEList<GeneralOrdering>(GeneralOrdering.class, this, UML2WithIDPackage.EVENT_OCCURRENCE__TO_BEFORE, UML2WithIDPackage.GENERAL_ORDERING__AFTER);
		}
		return toBefore;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MessageEnd.class) {
			switch (derivedFeatureID) {
				case UML2WithIDPackage.EVENT_OCCURRENCE__RECEIVE_MESSAGE: return UML2WithIDPackage.MESSAGE_END__RECEIVE_MESSAGE;
				case UML2WithIDPackage.EVENT_OCCURRENCE__SEND_MESSAGE: return UML2WithIDPackage.MESSAGE_END__SEND_MESSAGE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MessageEnd.class) {
			switch (baseFeatureID) {
				case UML2WithIDPackage.MESSAGE_END__RECEIVE_MESSAGE: return UML2WithIDPackage.EVENT_OCCURRENCE__RECEIVE_MESSAGE;
				case UML2WithIDPackage.MESSAGE_END__SEND_MESSAGE: return UML2WithIDPackage.EVENT_OCCURRENCE__SEND_MESSAGE;
				default: return -1;
			}
		}
