 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LiteralUnlimitedNaturalImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LiteralUnlimitedNaturalImpl extends LiteralSpecificationImpl implements LiteralUnlimitedNatural {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getLiteralUnlimitedNatural();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LITERAL_UNLIMITED_NATURAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.LITERAL_UNLIMITED_NATURAL__VALUE:
				return getValue();
		}
