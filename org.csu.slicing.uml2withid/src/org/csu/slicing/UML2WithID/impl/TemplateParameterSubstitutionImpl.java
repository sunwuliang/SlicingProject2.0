 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateParameterSubstitutionImpl#getFormal <em>Formal</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateParameterSubstitutionImpl#getTemplateBinding <em>Template Binding</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateParameterSubstitutionImpl#getActual <em>Actual</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.TemplateParameterSubstitutionImpl#getOwnedActual <em>Owned Actual</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateParameterSubstitutionImpl extends ElementImpl implements TemplateParameterSubstitution {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getTemplateParameterSubstitution();
	}
		...
		if (formal != null && formal.eIsProxy()) {
			...
			if (formal != oldFormal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__FORMAL, oldFormal, formal));
			}
		}
		return formal;
	}
	...
	public void setFormal(TemplateParameter newFormal) {
		...
		formal = newFormal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__FORMAL, oldFormal, formal));
	}
	...
	public TemplateBinding getTemplateBinding() {
		if (eContainerFeatureID() != UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING) return null;
	...
	public NotificationChain basicSetTemplateBinding(TemplateBinding newTemplateBinding, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTemplateBinding, UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING, msgs);
		return msgs;
	}
	...
	public void setTemplateBinding(TemplateBinding newTemplateBinding) {
		if (newTemplateBinding != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING && newTemplateBinding != null)) {
			...
			if (newTemplateBinding != null)
				msgs = ((InternalEObject)newTemplateBinding).eInverseAdd(this, UML2WithIDPackage.TEMPLATE_BINDING__PARAMETER_SUBSTITUTION, TemplateBinding.class, msgs);
			msgs = basicSetTemplateBinding(newTemplateBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING, newTemplateBinding, newTemplateBinding));
	}
	...
	public EList<ParameterableElement> getActual() {
		if (actual == null) {
			actual = new EObjectResolvingEList<ParameterableElement>(ParameterableElement.class, this, UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__ACTUAL);
		}
		return actual;
	}
	...
	public EList<ParameterableElement> getOwnedActual() {
		if (ownedActual == null) {
			ownedActual = new EObjectContainmentEList<ParameterableElement>(ParameterableElement.class, this, UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__OWNED_ACTUAL);
		}
		return ownedActual;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__OWNED_ACTUAL:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.TEMPLATE_BINDING__PARAMETER_SUBSTITUTION, TemplateBinding.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__FORMAL:
				if (resolve) return getFormal();
				return basicGetFormal();
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__TEMPLATE_BINDING:
				return getTemplateBinding();
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__ACTUAL:
				return getActual();
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION__OWNED_ACTUAL:
