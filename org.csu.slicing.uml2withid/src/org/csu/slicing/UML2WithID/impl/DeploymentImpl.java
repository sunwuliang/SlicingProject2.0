 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DeploymentImpl#getDeployedArtifact <em>Deployed Artifact</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DeploymentImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.DeploymentImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeploymentImpl extends DependencyImpl implements Deployment {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getDeployment();
	}
	...
	public EList<DeployedArtifact> getDeployedArtifact() {
		if (deployedArtifact == null) {
			deployedArtifact = new EObjectResolvingEList<DeployedArtifact>(DeployedArtifact.class, this, UML2WithIDPackage.DEPLOYMENT__DEPLOYED_ARTIFACT);
		}
	...
	public DeploymentTarget getLocation() {
		if (eContainerFeatureID() != UML2WithIDPackage.DEPLOYMENT__LOCATION) return null;
	...
	public NotificationChain basicSetLocation(DeploymentTarget newLocation, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLocation, UML2WithIDPackage.DEPLOYMENT__LOCATION, msgs);
		return msgs;
	}
	...
	public void setLocation(DeploymentTarget newLocation) {
		if (newLocation != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.DEPLOYMENT__LOCATION && newLocation != null)) {
			...
			if (newLocation != null)
				msgs = ((InternalEObject)newLocation).eInverseAdd(this, UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYMENT, DeploymentTarget.class, msgs);
			msgs = basicSetLocation(newLocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.DEPLOYMENT__LOCATION, newLocation, newLocation));
	}
	...
	public EList<DeploymentSpecification> getConfiguration() {
		if (configuration == null) {
			configuration = new EObjectContainmentEList<DeploymentSpecification>(DeploymentSpecification.class, this, UML2WithIDPackage.DEPLOYMENT__CONFIGURATION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.DEPLOYMENT__LOCATION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.DEPLOYMENT__CONFIGURATION:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.DEPLOYMENT__LOCATION:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYMENT, DeploymentTarget.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.DEPLOYMENT__DEPLOYED_ARTIFACT:
