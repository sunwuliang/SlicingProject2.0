 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ExpressionImpl#getSymbol <em>Symbol</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ExpressionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExpressionImpl extends OpaqueExpressionImpl implements Expression {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getExpression();
	}
	...
	public void setSymbol(String newSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.EXPRESSION__SYMBOL, oldSymbol, symbol));
	}
	...
	public EList<ValueSpecification> getOperand() {
		if (operand == null) {
			operand = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, UML2WithIDPackage.EXPRESSION__OPERAND);
		}
		return operand;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.EXPRESSION__OPERAND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.EXPRESSION__SYMBOL:
				return getSymbol();
			case UML2WithIDPackage.EXPRESSION__OPERAND:
				return getOperand();
		}
