 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LifelineImpl#getCoveredBy <em>Covered By</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LifelineImpl#getRepresents <em>Represents</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LifelineImpl#getInteraction <em>Interaction</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LifelineImpl#getSelector <em>Selector</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.LifelineImpl#getDecomposedAs <em>Decomposed As</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LifelineImpl extends NamedElementImpl implements Lifeline {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getLifeline();
	}
	...
	public EList<InteractionFragment> getCoveredBy() {
		if (coveredBy == null) {
			coveredBy = new EObjectWithInverseResolvingEList.ManyInverse<InteractionFragment>(InteractionFragment.class, this, UML2WithIDPackage.LIFELINE__COVERED_BY, UML2WithIDPackage.INTERACTION_FRAGMENT__COVERED);
		}
		return coveredBy;
	}
		...
		if (represents != null && represents.eIsProxy()) {
			...
			if (represents != oldRepresents) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.LIFELINE__REPRESENTS, oldRepresents, represents));
			}
		}
		return represents;
	}
	...
	public void setRepresents(ConnectableElement newRepresents) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LIFELINE__REPRESENTS, oldRepresents, represents));
	}
	...
	public Interaction getInteraction() {
		if (eContainerFeatureID() != UML2WithIDPackage.LIFELINE__INTERACTION) return null;
	...
	public NotificationChain basicSetInteraction(Interaction newInteraction, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newInteraction, UML2WithIDPackage.LIFELINE__INTERACTION, msgs);
		return msgs;
	}
	...
	public void setInteraction(Interaction newInteraction) {
		if (newInteraction != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.LIFELINE__INTERACTION && newInteraction != null)) {
			...
			if (newInteraction != null)
				msgs = ((InternalEObject)newInteraction).eInverseAdd(this, UML2WithIDPackage.INTERACTION__LIFELINE, Interaction.class, msgs);
			msgs = basicSetInteraction(newInteraction, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LIFELINE__INTERACTION, newInteraction, newInteraction));
	}
	...
	public NotificationChain basicSetSelector(OpaqueExpression newSelector, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LIFELINE__SELECTOR, oldSelector, newSelector);
	...
	public void setSelector(OpaqueExpression newSelector) {
		if (newSelector != selector) {
			NotificationChain msgs = null;
			if (selector != null)
				msgs = ((InternalEObject)selector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.LIFELINE__SELECTOR, null, msgs);
			if (newSelector != null)
				msgs = ((InternalEObject)newSelector).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.LIFELINE__SELECTOR, null, msgs);
			msgs = basicSetSelector(newSelector, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LIFELINE__SELECTOR, newSelector, newSelector));
	}
	...
	public PartDecomposition getDecomposedAs() {
		if (decomposedAs != null && decomposedAs.eIsProxy()) {
			...
			if (decomposedAs != oldDecomposedAs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.LIFELINE__DECOMPOSED_AS, oldDecomposedAs, decomposedAs));
			}
		}
		return decomposedAs;
	}
	...
	public void setDecomposedAs(PartDecomposition newDecomposedAs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.LIFELINE__DECOMPOSED_AS, oldDecomposedAs, decomposedAs));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.LIFELINE__COVERED_BY:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getCoveredBy()).basicAdd(otherEnd, msgs);
			case UML2WithIDPackage.LIFELINE__INTERACTION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.LIFELINE__SELECTOR:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.LIFELINE__INTERACTION:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.INTERACTION__LIFELINE, Interaction.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.LIFELINE__COVERED_BY:
				return getCoveredBy();
			case UML2WithIDPackage.LIFELINE__REPRESENTS:
			...
			case UML2WithIDPackage.LIFELINE__SELECTOR:
				return getSelector();
			case UML2WithIDPackage.LIFELINE__DECOMPOSED_AS:
