 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends VertexImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getPseudostate();
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.PSEUDOSTATE__KIND:
				return getKind();
		}
