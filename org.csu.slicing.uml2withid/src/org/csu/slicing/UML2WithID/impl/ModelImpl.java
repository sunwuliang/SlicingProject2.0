 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.ModelImpl#getViewpoint <em>Viewpoint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends PackageImpl implements Model {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getModel();
	}
	...
	public void setViewpoint(String newViewpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.MODEL__VIEWPOINT, oldViewpoint, viewpoint));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.MODEL__VIEWPOINT:
				return getViewpoint();
		}
