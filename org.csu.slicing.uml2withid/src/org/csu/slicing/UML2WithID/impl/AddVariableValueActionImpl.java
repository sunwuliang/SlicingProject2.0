 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.AddVariableValueActionImpl#isIsReplaceAll <em>Is Replace All</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.AddVariableValueActionImpl#getInsertAt <em>Insert At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddVariableValueActionImpl extends WriteVariableActionImpl implements AddVariableValueAction {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getAddVariableValueAction();
	}
	...
	public void setIsReplaceAll(boolean newIsReplaceAll) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__IS_REPLACE_ALL, oldIsReplaceAll, isReplaceAll));
	}
	...
	public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, oldInsertAt, newInsertAt);
	...
	public void setInsertAt(InputPin newInsertAt) {
		if (newInsertAt != insertAt) {
			...
			if (insertAt != null)
				msgs = ((InternalEObject)insertAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, null, msgs);
			if (newInsertAt != null)
				msgs = ((InternalEObject)newInsertAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, null, msgs);
			msgs = basicSetInsertAt(newInsertAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, newInsertAt, newInsertAt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION__IS_REPLACE_ALL:
