 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.IntervalImpl#getMin <em>Min</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.IntervalImpl#getMax <em>Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntervalImpl extends ValueSpecificationImpl implements Interval {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getInterval();
	}
	...
	public EList<ValueSpecification> getMin() {
		if (min == null) {
			min = new EObjectResolvingEList<ValueSpecification>(ValueSpecification.class, this, UML2WithIDPackage.INTERVAL__MIN);
		}
		return min;
	}
	...
	public EList<ValueSpecification> getMax() {
		if (max == null) {
			max = new EObjectResolvingEList<ValueSpecification>(ValueSpecification.class, this, UML2WithIDPackage.INTERVAL__MAX);
		}
		return max;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.INTERVAL__MIN:
				return getMin();
			case UML2WithIDPackage.INTERVAL__MAX:
				return getMax();
		}
