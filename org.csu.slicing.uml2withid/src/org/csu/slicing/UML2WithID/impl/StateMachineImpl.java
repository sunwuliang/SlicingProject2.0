 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StateMachineImpl#getRegion <em>Region</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StateMachineImpl#getConnectionPoint <em>Connection Point</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StateMachineImpl#getExtendedStateMachine <em>Extended State Machine</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StateMachineImpl#getStateMachine_redefinitionContext <em>State Machine redefinition Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateMachineImpl extends BehaviorImpl implements StateMachine {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getStateMachine();
	}
	...
	public EList<Region> getRegion() {
		if (region == null) {
			region = new EObjectContainmentWithInverseEList<Region>(Region.class, this, UML2WithIDPackage.STATE_MACHINE__REGION, UML2WithIDPackage.REGION__STATE_MACHINE);
		}
		return region;
	}
	...
	public EList<Pseudostate> getConnectionPoint() {
		if (connectionPoint == null) {
			connectionPoint = new EObjectContainmentEList<Pseudostate>(Pseudostate.class, this, UML2WithIDPackage.STATE_MACHINE__CONNECTION_POINT);
		}
		...
		if (extendedStateMachine != null && extendedStateMachine.eIsProxy()) {
			...
			if (extendedStateMachine != oldExtendedStateMachine) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.STATE_MACHINE__EXTENDED_STATE_MACHINE, oldExtendedStateMachine, extendedStateMachine));
			}
		}
	...
	public void setExtendedStateMachine(StateMachine newExtendedStateMachine) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.STATE_MACHINE__EXTENDED_STATE_MACHINE, oldExtendedStateMachine, extendedStateMachine));
	}
	...
	public BehavioredClassifier getStateMachine_redefinitionContext() {
		if (eContainerFeatureID() != UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT) return null;
	...
	public NotificationChain basicSetStateMachine_redefinitionContext(BehavioredClassifier newStateMachine_redefinitionContext, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newStateMachine_redefinitionContext, UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT, msgs);
		return msgs;
	}
	...
	public void setStateMachine_redefinitionContext(BehavioredClassifier newStateMachine_redefinitionContext) {
		if (newStateMachine_redefinitionContext != eInternalContainer() || (eContainerFeatureID() != UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT && newStateMachine_redefinitionContext != null)) {
			...
			if (newStateMachine_redefinitionContext != null)
				msgs = ((InternalEObject)newStateMachine_redefinitionContext).eInverseAdd(this, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_STATE_MACHINE, BehavioredClassifier.class, msgs);
			msgs = basicSetStateMachine_redefinitionContext(newStateMachine_redefinitionContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT, newStateMachine_redefinitionContext, newStateMachine_redefinitionContext));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.STATE_MACHINE__REGION:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getRegion()).basicAdd(otherEnd, msgs);
			case UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.STATE_MACHINE__CONNECTION_POINT:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UML2WithIDPackage.STATE_MACHINE__STATE_MACHINE_REDEFINITION_CONTEXT:
				return eInternalContainer().eInverseRemove(this, UML2WithIDPackage.BEHAVIORED_CLASSIFIER__OWNED_STATE_MACHINE, BehavioredClassifier.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.STATE_MACHINE__EXTENDED_STATE_MACHINE:
