 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NodeImpl#getDeployment <em>Deployment</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NodeImpl#getDeployedElement <em>Deployed Element</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.NodeImpl#getNestedNode <em>Nested Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeImpl extends ClassImpl implements Node {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getNode();
	}
	...
	public EList<Deployment> getDeployment() {
		if (deployment == null) {
			deployment = new EObjectContainmentWithInverseEList<Deployment>(Deployment.class, this, UML2WithIDPackage.NODE__DEPLOYMENT, UML2WithIDPackage.DEPLOYMENT__LOCATION);
		}
		return deployment;
	}
	...
	public EList<PackageableElement> getDeployedElement() {
		if (deployedElement == null) {
			deployedElement = new EObjectResolvingEList<PackageableElement>(PackageableElement.class, this, UML2WithIDPackage.NODE__DEPLOYED_ELEMENT);
		}
	...
	public EList<Node> getNestedNode() {
		if (nestedNode == null) {
			nestedNode = new EObjectContainmentEList<Node>(Node.class, this, UML2WithIDPackage.NODE__NESTED_NODE);
		}
		return nestedNode;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.NODE__DEPLOYMENT:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UML2WithIDPackage.NODE__NESTED_NODE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2WithIDPackage.NODE__DEPLOYED_ELEMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DeploymentTarget.class) {
			switch (derivedFeatureID) {
				case UML2WithIDPackage.NODE__DEPLOYMENT: return UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYMENT;
				case UML2WithIDPackage.NODE__DEPLOYED_ELEMENT: return UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYED_ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DeploymentTarget.class) {
			switch (baseFeatureID) {
				case UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYMENT: return UML2WithIDPackage.NODE__DEPLOYMENT;
				case UML2WithIDPackage.DEPLOYMENT_TARGET__DEPLOYED_ELEMENT: return UML2WithIDPackage.NODE__DEPLOYED_ELEMENT;
				default: return -1;
			}
		}
