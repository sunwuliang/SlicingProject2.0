 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.EncapsulatedClassifierImpl#getOwnedPort <em>Owned Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EncapsulatedClassifierImpl extends StructuredClassifierImpl implements EncapsulatedClassifier {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getEncapsulatedClassifier();
	}
	...
	public EList<Port> getOwnedPort() {
		if (ownedPort == null) {
			ownedPort = new EObjectContainmentEList<Port>(Port.class, this, UML2WithIDPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT);
		}
		return ownedPort;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT:
