 ...
 * <ul>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StructuralFeatureActionImpl#getStructuralFeature <em>Structural Feature</em>}</li>
 *   <li>{@link org.csu.slicing.UML2WithID.impl.StructuralFeatureActionImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuralFeatureActionImpl extends ActionImpl implements StructuralFeatureAction {
	...
	protected EClass eStaticClass() {
		return UML2WithIDPackage.eINSTANCE.getStructuralFeatureAction();
	}
		...
		if (structuralFeature != null && structuralFeature.eIsProxy()) {
			...
			if (structuralFeature != oldStructuralFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
			}
		}
	...
	public void setStructuralFeature(StructuralFeature newStructuralFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
	}
	...
	public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
		...
		object = newObject;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, oldObject, newObject);
	...
	public void setObject(InputPin newObject) {
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject)object).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, null, msgs);
			if (newObject != null)
				msgs = ((InternalEObject)newObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, null, msgs);
			msgs = basicSetObject(newObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, newObject, newObject));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__OBJECT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION__STRUCTURAL_FEATURE:
