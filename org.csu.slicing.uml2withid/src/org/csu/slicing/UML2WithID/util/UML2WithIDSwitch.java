 ...
 * @generated
 */
public class UML2WithIDSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UML2WithIDPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UML2WithIDPackage.MULTIPLICITY_ELEMENT: {
			...
			case UML2WithIDPackage.NAMED_ELEMENT: {
			...
			case UML2WithIDPackage.NAMESPACE: {
			...
			case UML2WithIDPackage.OPAQUE_EXPRESSION: {
			...
			case UML2WithIDPackage.VALUE_SPECIFICATION: {
			...
			case UML2WithIDPackage.EXPRESSION: {
			...
			case UML2WithIDPackage.COMMENT: {
			...
			case UML2WithIDPackage.DIRECTED_RELATIONSHIP: {
			...
			case UML2WithIDPackage.RELATIONSHIP: {
			...
			case UML2WithIDPackage.CLASS: {
				org.csu.slicing.UML2WithID.Class class_ = (org.csu.slicing.UML2WithID.Class)theEObject;
			...
			case UML2WithIDPackage.PROPERTY: {
			...
			case UML2WithIDPackage.OPERATION: {
			...
			case UML2WithIDPackage.TYPED_ELEMENT: {
			...
			case UML2WithIDPackage.PARAMETER: {
			...
			case UML2WithIDPackage.PACKAGE: {
				org.csu.slicing.UML2WithID.Package package_ = (org.csu.slicing.UML2WithID.Package)theEObject;
			...
			case UML2WithIDPackage.ENUMERATION: {
			...
			case UML2WithIDPackage.DATA_TYPE: {
			...
			case UML2WithIDPackage.ENUMERATION_LITERAL: {
			...
			case UML2WithIDPackage.PRIMITIVE_TYPE: {
			...
			case UML2WithIDPackage.CLASSIFIER: {
			...
			case UML2WithIDPackage.FEATURE: {
			...
			case UML2WithIDPackage.CONSTRAINT: {
			...
			case UML2WithIDPackage.LITERAL_BOOLEAN: {
			...
			case UML2WithIDPackage.LITERAL_SPECIFICATION: {
			...
			case UML2WithIDPackage.LITERAL_STRING: {
			...
			case UML2WithIDPackage.LITERAL_NULL: {
			...
			case UML2WithIDPackage.LITERAL_INTEGER: {
			...
			case UML2WithIDPackage.LITERAL_UNLIMITED_NATURAL: {
			...
			case UML2WithIDPackage.BEHAVIORAL_FEATURE: {
			...
			case UML2WithIDPackage.STRUCTURAL_FEATURE: {
			...
			case UML2WithIDPackage.INSTANCE_SPECIFICATION: {
			...
			case UML2WithIDPackage.INSTANCE_VALUE: {
			...
			case UML2WithIDPackage.REDEFINABLE_ELEMENT: {
			...
			case UML2WithIDPackage.GENERALIZATION: {
			...
			case UML2WithIDPackage.PACKAGEABLE_ELEMENT: {
			...
			case UML2WithIDPackage.ELEMENT_IMPORT: {
			...
			case UML2WithIDPackage.PACKAGE_IMPORT: {
			...
			case UML2WithIDPackage.ASSOCIATION: {
			...
			case UML2WithIDPackage.PACKAGE_MERGE: {
			...
			case UML2WithIDPackage.STEREOTYPE: {
			...
			case UML2WithIDPackage.PROFILE: {
			...
			case UML2WithIDPackage.PROFILE_APPLICATION: {
			...
			case UML2WithIDPackage.EXTENSION: {
			...
			case UML2WithIDPackage.EXTENSION_END: {
			...
			case UML2WithIDPackage.BEHAVIOR: {
			...
			case UML2WithIDPackage.BEHAVIORED_CLASSIFIER: {
			...
			case UML2WithIDPackage.ACTIVITY: {
			...
			case UML2WithIDPackage.PERMISSION: {
			...
			case UML2WithIDPackage.DEPENDENCY: {
			...
			case UML2WithIDPackage.ABSTRACTION: {
			...
			case UML2WithIDPackage.REALIZATION: {
			...
			case UML2WithIDPackage.SUBSTITUTION: {
			...
			case UML2WithIDPackage.GENERALIZATION_SET: {
			...
			case UML2WithIDPackage.ASSOCIATION_CLASS: {
			...
			case UML2WithIDPackage.INFORMATION_ITEM: {
			...
			case UML2WithIDPackage.INFORMATION_FLOW: {
			...
			case UML2WithIDPackage.CONNECTOR_END: {
			...
			case UML2WithIDPackage.CONNECTABLE_ELEMENT: {
			...
			case UML2WithIDPackage.CONNECTOR: {
			...
			case UML2WithIDPackage.STRUCTURED_CLASSIFIER: {
			...
			case UML2WithIDPackage.ACTIVITY_EDGE: {
			...
			case UML2WithIDPackage.ACTIVITY_GROUP: {
			...
			case UML2WithIDPackage.ACTIVITY_NODE: {
			...
			case UML2WithIDPackage.OBJECT_NODE: {
			...
			case UML2WithIDPackage.CONTROL_NODE: {
			...
			case UML2WithIDPackage.CONTROL_FLOW: {
			...
			case UML2WithIDPackage.OBJECT_FLOW: {
			...
			case UML2WithIDPackage.INITIAL_NODE: {
			...
			case UML2WithIDPackage.FINAL_NODE: {
			...
			case UML2WithIDPackage.ACTIVITY_FINAL_NODE: {
			...
			case UML2WithIDPackage.DECISION_NODE: {
			...
			case UML2WithIDPackage.MERGE_NODE: {
			...
			case UML2WithIDPackage.EXECUTABLE_NODE: {
			...
			case UML2WithIDPackage.OUTPUT_PIN: {
			...
			case UML2WithIDPackage.INPUT_PIN: {
			...
			case UML2WithIDPackage.ACTIVITY_PARAMETER_NODE: {
			...
			case UML2WithIDPackage.VALUE_PIN: {
			...
			case UML2WithIDPackage.INTERFACE: {
			...
			case UML2WithIDPackage.IMPLEMENTATION: {
			...
			case UML2WithIDPackage.ARTIFACT: {
			...
			case UML2WithIDPackage.MANIFESTATION: {
			...
			case UML2WithIDPackage.USE_CASE: {
			...
			case UML2WithIDPackage.EXTENSION_POINT: {
			...
			case UML2WithIDPackage.INCLUDE: {
			...
			case UML2WithIDPackage.COLLABORATION_OCCURRENCE: {
			...
			case UML2WithIDPackage.COLLABORATION: {
			...
			case UML2WithIDPackage.ENCAPSULATED_CLASSIFIER: {
			...
			case UML2WithIDPackage.CALL_TRIGGER: {
			...
			case UML2WithIDPackage.MESSAGE_TRIGGER: {
			...
			case UML2WithIDPackage.CHANGE_TRIGGER: {
			...
			case UML2WithIDPackage.TRIGGER: {
			...
			case UML2WithIDPackage.RECEPTION: {
			...
			case UML2WithIDPackage.SIGNAL_TRIGGER: {
			...
			case UML2WithIDPackage.TIME_TRIGGER: {
			...
			case UML2WithIDPackage.ANY_TRIGGER: {
			...
			case UML2WithIDPackage.VARIABLE: {
			...
			case UML2WithIDPackage.STRUCTURED_ACTIVITY_NODE: {
			...
			case UML2WithIDPackage.CONDITIONAL_NODE: {
			...
			case UML2WithIDPackage.LOOP_NODE: {
			...
			case UML2WithIDPackage.INTERACTION: {
			...
			case UML2WithIDPackage.INTERACTION_FRAGMENT: {
			...
			case UML2WithIDPackage.LIFELINE: {
			...
			case UML2WithIDPackage.MESSAGE: {
			...
			case UML2WithIDPackage.GENERAL_ORDERING: {
			...
			case UML2WithIDPackage.MESSAGE_END: {
			...
			case UML2WithIDPackage.EVENT_OCCURRENCE: {
			...
			case UML2WithIDPackage.EXECUTION_OCCURRENCE: {
			...
			case UML2WithIDPackage.STATE_INVARIANT: {
			...
			case UML2WithIDPackage.TEMPLATE_SIGNATURE: {
			...
			case UML2WithIDPackage.TEMPLATE_PARAMETER: {
			...
			case UML2WithIDPackage.TEMPLATEABLE_ELEMENT: {
			...
			case UML2WithIDPackage.STRING_EXPRESSION: {
			...
			case UML2WithIDPackage.PARAMETERABLE_ELEMENT: {
			...
			case UML2WithIDPackage.TEMPLATE_BINDING: {
			...
			case UML2WithIDPackage.TEMPLATE_PARAMETER_SUBSTITUTION: {
			...
			case UML2WithIDPackage.OPERATION_TEMPLATE_PARAMETER: {
			...
			case UML2WithIDPackage.CLASSIFIER_TEMPLATE_PARAMETER: {
			...
			case UML2WithIDPackage.PARAMETERABLE_CLASSIFIER: {
			...
			case UML2WithIDPackage.REDEFINABLE_TEMPLATE_SIGNATURE: {
			...
			case UML2WithIDPackage.TEMPLATEABLE_CLASSIFIER: {
			...
			case UML2WithIDPackage.CONNECTABLE_ELEMENT_TEMPLATE_PARAMETER: {
			...
			case UML2WithIDPackage.FORK_NODE: {
			...
			case UML2WithIDPackage.JOIN_NODE: {
			...
			case UML2WithIDPackage.FLOW_FINAL_NODE: {
			...
			case UML2WithIDPackage.CENTRAL_BUFFER_NODE: {
			...
			case UML2WithIDPackage.ACTIVITY_PARTITION: {
			...
			case UML2WithIDPackage.EXPANSION_NODE: {
			...
			case UML2WithIDPackage.EXPANSION_REGION: {
			...
			case UML2WithIDPackage.EXCEPTION_HANDLER: {
			...
			case UML2WithIDPackage.INTERACTION_OCCURRENCE: {
			...
			case UML2WithIDPackage.PART_DECOMPOSITION: {
			...
			case UML2WithIDPackage.INTERACTION_OPERAND: {
			...
			case UML2WithIDPackage.INTERACTION_CONSTRAINT: {
			...
			case UML2WithIDPackage.COMBINED_FRAGMENT: {
			...
			case UML2WithIDPackage.CONTINUATION: {
			...
			case UML2WithIDPackage.STATE_MACHINE: {
			...
			case UML2WithIDPackage.PSEUDOSTATE: {
			...
			case UML2WithIDPackage.CONNECTION_POINT_REFERENCE: {
			...
			case UML2WithIDPackage.TRANSITION: {
			...
			case UML2WithIDPackage.FINAL_STATE: {
			...
			case UML2WithIDPackage.CREATE_OBJECT_ACTION: {
			...
			case UML2WithIDPackage.DESTROY_OBJECT_ACTION: {
			...
			case UML2WithIDPackage.TEST_IDENTITY_ACTION: {
			...
			case UML2WithIDPackage.READ_SELF_ACTION: {
			...
			case UML2WithIDPackage.STRUCTURAL_FEATURE_ACTION: {
			...
			case UML2WithIDPackage.READ_STRUCTURAL_FEATURE_ACTION: {
			...
			case UML2WithIDPackage.WRITE_STRUCTURAL_FEATURE_ACTION: {
			...
			case UML2WithIDPackage.CLEAR_STRUCTURAL_FEATURE_ACTION: {
			...
			case UML2WithIDPackage.REMOVE_STRUCTURAL_FEATURE_VALUE_ACTION: {
			...
			case UML2WithIDPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION: {
			...
			case UML2WithIDPackage.LINK_ACTION: {
			...
			case UML2WithIDPackage.LINK_END_DATA: {
			...
			case UML2WithIDPackage.READ_LINK_ACTION: {
			...
			case UML2WithIDPackage.LINK_END_CREATION_DATA: {
			...
			case UML2WithIDPackage.CREATE_LINK_ACTION: {
			...
			case UML2WithIDPackage.WRITE_LINK_ACTION: {
			...
			case UML2WithIDPackage.DESTROY_LINK_ACTION: {
			...
			case UML2WithIDPackage.CLEAR_ASSOCIATION_ACTION: {
			...
			case UML2WithIDPackage.VARIABLE_ACTION: {
			...
			case UML2WithIDPackage.READ_VARIABLE_ACTION: {
			...
			case UML2WithIDPackage.WRITE_VARIABLE_ACTION: {
			...
			case UML2WithIDPackage.CLEAR_VARIABLE_ACTION: {
			...
			case UML2WithIDPackage.ADD_VARIABLE_VALUE_ACTION: {
			...
			case UML2WithIDPackage.REMOVE_VARIABLE_VALUE_ACTION: {
			...
			case UML2WithIDPackage.APPLY_FUNCTION_ACTION: {
			...
			case UML2WithIDPackage.PRIMITIVE_FUNCTION: {
			...
			case UML2WithIDPackage.CALL_ACTION: {
			...
			case UML2WithIDPackage.INVOCATION_ACTION: {
			...
			case UML2WithIDPackage.SEND_SIGNAL_ACTION: {
			...
			case UML2WithIDPackage.BROADCAST_SIGNAL_ACTION: {
			...
			case UML2WithIDPackage.SEND_OBJECT_ACTION: {
			...
			case UML2WithIDPackage.CALL_OPERATION_ACTION: {
			...
			case UML2WithIDPackage.CALL_BEHAVIOR_ACTION: {
			...
			case UML2WithIDPackage.TIME_EXPRESSION: {
			...
			case UML2WithIDPackage.DURATION: {
			...
			case UML2WithIDPackage.TIME_OBSERVATION_ACTION: {
			...
			case UML2WithIDPackage.DURATION_INTERVAL: {
			...
			case UML2WithIDPackage.INTERVAL: {
			...
			case UML2WithIDPackage.TIME_CONSTRAINT: {
			...
			case UML2WithIDPackage.INTERVAL_CONSTRAINT: {
			...
			case UML2WithIDPackage.TIME_INTERVAL: {
			...
			case UML2WithIDPackage.DURATION_OBSERVATION_ACTION: {
			...
			case UML2WithIDPackage.DURATION_CONSTRAINT: {
			...
			case UML2WithIDPackage.DATA_STORE_NODE: {
			...
			case UML2WithIDPackage.INTERRUPTIBLE_ACTIVITY_REGION: {
			...
			case UML2WithIDPackage.PARAMETER_SET: {
			...
			case UML2WithIDPackage.COMPONENT: {
			...
			case UML2WithIDPackage.DEPLOYMENT: {
			...
			case UML2WithIDPackage.DEPLOYED_ARTIFACT: {
			...
			case UML2WithIDPackage.DEPLOYMENT_TARGET: {
			...
			case UML2WithIDPackage.EXECUTION_ENVIRONMENT: {
			...
			case UML2WithIDPackage.COMMUNICATION_PATH: {
			...
			case UML2WithIDPackage.PROTOCOL_CONFORMANCE: {
			...
			case UML2WithIDPackage.PROTOCOL_STATE_MACHINE: {
			...
			case UML2WithIDPackage.PROTOCOL_TRANSITION: {
			...
			case UML2WithIDPackage.READ_EXTENT_ACTION: {
			...
			case UML2WithIDPackage.RECLASSIFY_OBJECT_ACTION: {
			...
			case UML2WithIDPackage.READ_IS_CLASSIFIED_OBJECT_ACTION: {
			...
			case UML2WithIDPackage.START_OWNED_BEHAVIOR_ACTION: {
			...
			case UML2WithIDPackage.QUALIFIER_VALUE: {
			...
			case UML2WithIDPackage.READ_LINK_OBJECT_END_ACTION: {
			...
			case UML2WithIDPackage.READ_LINK_OBJECT_END_QUALIFIER_ACTION: {
			...
			case UML2WithIDPackage.CREATE_LINK_OBJECT_ACTION: {
			...
			case UML2WithIDPackage.ACCEPT_EVENT_ACTION: {
			...
			case UML2WithIDPackage.ACCEPT_CALL_ACTION: {
			...
			case UML2WithIDPackage.REPLY_ACTION: {
			...
			case UML2WithIDPackage.RAISE_EXCEPTION_ACTION: {
			...
			case UML2WithIDPackage.DEPLOYMENT_SPECIFICATION: {
	 ...
	 * @generated
	 */
	public T caseClass(org.csu.slicing.UML2WithID.Class object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePackage(org.csu.slicing.UML2WithID.Package object) {
		return null;
	}
